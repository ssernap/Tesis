...
#include "ne_ds.h"
#include "friccion_aislada_d30b7e43_1_ds.h"
...
"friccion_aislada.Robot_Delta.PS_Gain1" , 0U , 8 , NE_EQUATION_DOMAIN_TIME ,
"friccion_aislada/Robot Delta/PS Gain1" , 1U , 0U , TRUE , 1.0 } } ; static
NeVariableData s_variable_data [ 1 ] = { {
"friccion_aislada.Robot_Delta.PS_Gain1.O" , 0U , 2 ,
"friccion_aislada/Robot Delta/PS Gain1" , 1.0 , "1" , 0.0 , FALSE , FALSE ,
1U , 1U , NE_INIT_MODE_NONE , "O" } } ; static NeVariableData *
...
( void ) in ; local0 = out1 -> mB ; local0 . mX [ 0ULL ] = 0.0005 ; ( void )
ds ; ( void ) in ; return 0 ; } static int32_T ds_c_p ( const NeDynamicSystem
...
; } NeDynamicSystem * friccion_aislada_d30b7e43_1_dae_ds ( NeAllocator *
allocator , const void * params ) { NeDynamicSystem * ds ; _NeDynamicSystem *
_ds ; static NeDsIoInfo input_info [ 1 ] ; static NeDsIoInfo output_info [ 1
] ; ( void ) params ; _ds = ( _NeDynamicSystem * ) allocator -> mCallocFcn (
allocator , sizeof ( _NeDynamicSystem ) , 1 ) ; _ds -> mAlloc = * allocator ;
_ds -> mRefCnt = 1 ; ds = & _ds -> mBase ; ds -> mNumVariables = 1 ; ds ->
mNumDiscreteRealVariables = 0 ; ds -> mNumDifferentialVariables = 0 ; ds ->
mNumEquations = 1 ; ds -> mNumModes = 0 ; ds -> mNumMajorModes = 0 ; ds ->
mNumCache = 0 ; ds -> mNumZcs = 0 ; ds -> mNumAsserts = 0 ; ds ->
mNumAssertRanges = 0 ; ds -> mNumRanges = 0 ; ds -> mNumEquationRanges = 1 ;
ds -> mNumFundamentalSamples = 0 ; ds -> mNumDelays = 0 ; ds ->
mIsOutputLinear = 1 ; ds -> mNumIo [ NE_INPUT_IO_TYPE ] = 1 ; input_info [ 0
] . mIdentifier = "friccion_aislada/Robot Delta/PS Gain1_" ; input_info [ 0 ]
. mM = 1 ; input_info [ 0 ] . mN = 1 ; input_info [ 0 ] . mName =
"Robot_Delta.PS_Gain1.I" ; input_info [ 0 ] . mUnit = "1" ; ds -> mIo [
NE_INPUT_IO_TYPE ] = input_info ; ds -> mNumIo [ NE_OUTPUT_IO_TYPE ] = 1 ;
output_info [ 0 ] . mIdentifier = "friccion_aislada/Robot Delta/PS Gain1_" ;
output_info [ 0 ] . mM = 1 ; output_info [ 0 ] . mN = 1 ; output_info [ 0 ] .
mName = "Robot_Delta.PS_Gain1.O" ; output_info [ 0 ] . mUnit = "1" ; ds ->
