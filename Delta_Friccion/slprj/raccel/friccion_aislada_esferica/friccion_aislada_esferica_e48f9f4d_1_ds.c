...
#include "ne_ds.h"
#include "friccion_aislada_esferica_e48f9f4d_1_ds.h"
...
NeDynamicSystem * ds , const NeDynamicSystemInput * in , NeDsMethodOutput *
out ) ; static int32_T ds_ddf_p ( const NeDynamicSystem * ds , const
...
in , NeDsMethodOutput * out ) ; static int32_T ds_r ( const NeDynamicSystem *
ds , const NeDynamicSystemInput * in , NeDsMethodOutput * out ) ; static
...
NeEquationData s_equation_data [ 1 ] = { {
"friccion_aislada_esferica.Robot_Delta.PS_Gain2" , 0U , 8 ,
NE_EQUATION_DOMAIN_TIME , "friccion_aislada_esferica/Robot Delta/PS Gain2" ,
1U , 0U , TRUE , 1.0 } } ; static NeVariableData s_variable_data [ 1 ] = { {
"friccion_aislada_esferica.Robot_Delta.PS_Gain2.O" , 0U , 2 ,
"friccion_aislada_esferica/Robot Delta/PS Gain2" , 1.0 , "1" , 0.0 , FALSE ,
FALSE , 1U , 1U , NE_INIT_MODE_NONE , "O" } } ; static NeVariableData *
...
NeAssertData * s_assert_data = NULL ; static NeRange * s_assert_range = NULL
...
, 25U , 5U , 25U , 18U , NE_RANGE_TYPE_NORMAL } } ; static int32_T ds_s (
const NeDynamicSystem * ds , const NeDynamicSystemInput * in ,
NeDsMethodOutput * out1 ) { NeIntVector local0 ; ( void ) in ; local0 = out1
-> mS ; local0 . mX [ 0ULL ] = 0 ; ( void ) ds ; ( void ) in ; return 0 ; }
static int32_T ds_m_p ( const NeDynamicSystem * ds , const
NeDynamicSystemInput * in , NeDsMethodOutput * out1 ) { NeSparsityPattern
local0 ; ( void ) in ; local0 = out1 -> mM_P ; local0 . mJc [ 0ULL ] = 0 ;
local0 . mJc [ 1ULL ] = 0 ; ( void ) ds ; ( void ) in ; return 0 ; } static
int32_T ds_a_p ( const NeDynamicSystem * ds , const NeDynamicSystemInput * in
, NeDsMethodOutput * out1 ) { NeSparsityPattern local0 ; ( void ) in ; local0
= out1 -> mA_P ; local0 . mJc [ 0ULL ] = 0 ; local0 . mJc [ 1ULL ] = 1 ;
local0 . mIr [ 0ULL ] = 0 ; ( void ) ds ; ( void ) in ; return 0 ; } static
int32_T ds_a ( const NeDynamicSystem * ds , const NeDynamicSystemInput * in ,
NeDsMethodOutput * out1 ) { NeRealVector local0 ; ( void ) in ; local0 = out1
-> mA ; local0 . mX [ 0ULL ] = 1.0 ; ( void ) ds ; ( void ) in ; return 0 ; }
static int32_T ds_b_p ( const NeDynamicSystem * ds , const
NeDynamicSystemInput * in , NeDsMethodOutput * out1 ) { NeSparsityPattern
local0 ; ( void ) in ; local0 = out1 -> mB_P ; local0 . mJc [ 0ULL ] = 0 ;
local0 . mJc [ 1ULL ] = 1 ; local0 . mIr [ 0ULL ] = 0 ; ( void ) ds ; ( void
...
( void ) in ; local0 = out1 -> mB ; local0 . mX [ 0ULL ] = 0.02 ; ( void ) ds
...
NeDynamicSystemInput * in , NeDsMethodOutput * out1 ) { NeRealVector local0 ;
( void ) in ; local0 = out1 -> mF ; local0 . mX [ 0ULL ] = 0.0 ; ( void ) ds
; ( void ) in ; return 0 ; } static int32_T ds_vmf ( const NeDynamicSystem *
ds , const NeDynamicSystemInput * in , NeDsMethodOutput * out1 ) {
NeBoolVector local0 ; ( void ) in ; local0 = out1 -> mVMF ; local0 . mX [ 0 ]
= false ; ( void ) ds ; ( void ) in ; return 0 ; } static int32_T ds_slf (
const NeDynamicSystem * ds , const NeDynamicSystemInput * in ,
NeDsMethodOutput * out1 ) { NeBoolVector local0 ; ( void ) in ; local0 = out1
-> mSLF ; local0 . mX [ 0 ] = false ; ( void ) ds ; ( void ) in ; return 0 ;
} static int32_T ds_dxf_p ( const NeDynamicSystem * ds , const
NeDynamicSystemInput * in , NeDsMethodOutput * out1 ) { NeSparsityPattern
local0 ; ( void ) in ; local0 = out1 -> mDXF_P ; local0 . mJc [ 0ULL ] = 0 ;
local0 . mJc [ 1ULL ] = 0 ; ( void ) ds ; ( void ) in ; return 0 ; } static
int32_T ds_duf_p ( const NeDynamicSystem * ds , const NeDynamicSystemInput *
in , NeDsMethodOutput * out1 ) { NeSparsityPattern local0 ; ( void ) in ;
local0 = out1 -> mDUF_P ; local0 . mJc [ 0ULL ] = 0 ; local0 . mJc [ 1ULL ] =
0 ; ( void ) ds ; ( void ) in ; return 0 ; } static int32_T ds_dtf_p ( const
NeDynamicSystem * ds , const NeDynamicSystemInput * in , NeDsMethodOutput *
out1 ) { NeSparsityPattern local0 ; ( void ) in ; local0 = out1 -> mDTF_P ;
local0 . mJc [ 0ULL ] = 0 ; local0 . mJc [ 1ULL ] = 0 ; ( void ) ds ; ( void
) in ; return 0 ; } static int32_T ds_ddf_p ( const NeDynamicSystem * ds ,
const NeDynamicSystemInput * in , NeDsMethodOutput * out1 ) {
NeSparsityPattern local0 ; ( void ) in ; local0 = out1 -> mDDF_P ; local0 .
mJc [ 0ULL ] = 0 ; ( void ) ds ; ( void ) in ; return 0 ; } static int32_T
ds_tduf_p ( const NeDynamicSystem * ds , const NeDynamicSystemInput * in ,
NeDsMethodOutput * out1 ) { NeSparsityPattern local0 ; ( void ) in ; local0 =
out1 -> mTDUF_P ; local0 . mJc [ 0ULL ] = 0 ; local0 . mJc [ 1ULL ] = 1 ;
local0 . mIr [ 0ULL ] = 0 ; ( void ) ds ; ( void ) in ; return 0 ; } static
int32_T ds_tdxf_p ( const NeDynamicSystem * ds , const NeDynamicSystemInput *
in , NeDsMethodOutput * out1 ) { NeSparsityPattern local0 ; ( void ) in ;
local0 = out1 -> mTDXF_P ; local0 . mJc [ 0ULL ] = 0 ; local0 . mJc [ 1ULL ]
= 1 ; local0 . mIr [ 0ULL ] = 0 ; ( void ) ds ; ( void ) in ; return 0 ; }
static int32_T ds_y ( const NeDynamicSystem * ds , const NeDynamicSystemInput
* in , NeDsMethodOutput * out1 ) { NeRealVector local0 ; real_T X_idx_0 ;
X_idx_0 = in -> mX . mX [ 0 ] ; local0 = out1 -> mY ; local0 . mX [ 0ULL ] =
X_idx_0 ; ( void ) ds ; ( void ) in ; return 0 ; } static int32_T ds_dxy_p (
const NeDynamicSystem * ds , const NeDynamicSystemInput * in ,
NeDsMethodOutput * out1 ) { NeSparsityPattern local0 ; ( void ) in ; local0 =
out1 -> mDXY_P ; local0 . mJc [ 0ULL ] = 0 ; local0 . mJc [ 1ULL ] = 1 ;
local0 . mIr [ 0ULL ] = 0 ; ( void ) ds ; ( void ) in ; return 0 ; } static
int32_T ds_dxy ( const NeDynamicSystem * ds , const NeDynamicSystemInput * in
, NeDsMethodOutput * out1 ) { NeRealVector local0 ; ( void ) in ; local0 =
out1 -> mDXY ; local0 . mX [ 0ULL ] = 1.0 ; ( void ) ds ; ( void ) in ;
return 0 ; } static int32_T ds_duy_p ( const NeDynamicSystem * ds , const
NeDynamicSystemInput * in , NeDsMethodOutput * out1 ) { NeSparsityPattern
local0 ; ( void ) in ; local0 = out1 -> mDUY_P ; local0 . mJc [ 0ULL ] = 0 ;
local0 . mJc [ 1ULL ] = 0 ; ( void ) ds ; ( void ) in ; return 0 ; } static
int32_T ds_dty_p ( const NeDynamicSystem * ds , const NeDynamicSystemInput *
in , NeDsMethodOutput * out1 ) { NeSparsityPattern local0 ; ( void ) in ;
local0 = out1 -> mDTY_P ; local0 . mJc [ 0ULL ] = 0 ; local0 . mJc [ 1ULL ] =
0 ; ( void ) ds ; ( void ) in ; return 0 ; } static int32_T ds_r ( const
NeDynamicSystem * ds , const NeDynamicSystemInput * in , NeDsMethodOutput *
out1 ) { NeRealVector local0 ; ( void ) in ; local0 = out1 -> mR ; local0 .
mX [ 0ULL ] = 0.0 ; ( void ) ds ; ( void ) in ; return 0 ; } static int32_T
stub_method ( const NeDynamicSystem * ds , const NeDynamicSystemInput * in ,
NeDsMethodOutput * out ) { ( void ) ds ; ( void ) in ; ( void ) out ; return
0 ; } static NeDsMethodOutput * ds_output_s ( const NeDynamicSystem * ds ,
NeAllocator * allocator ) { NeDsMethodOutput * out ; ( void ) ds ; out = (
NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator , sizeof (
NeDsMethodOutput ) , 1 ) ; out -> mS . mN = 1 ; out -> mS . mX = ( int32_T *
) allocator -> mCallocFcn ( allocator , sizeof ( int32_T ) , 1 ) ; return out
; } static NeDsMethodOutput * ds_output_m_p ( const NeDynamicSystem * ds ,
NeAllocator * allocator ) { NeDsMethodOutput * out ; ( void ) ds ; out = (
NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator , sizeof (
NeDsMethodOutput ) , 1 ) ; out -> mM_P . mNumCol = 1 ; out -> mM_P . mNumRow
= 1 ; out -> mM_P . mJc = ( int32_T * ) allocator -> mCallocFcn ( allocator ,
sizeof ( int32_T ) , 2 ) ; out -> mM_P . mIr = ( int32_T * ) allocator ->
mCallocFcn ( allocator , sizeof ( int32_T ) , 0 ) ; return out ; } static
NeDsMethodOutput * ds_output_m ( const NeDynamicSystem * ds , NeAllocator *
allocator ) { NeDsMethodOutput * out ; ( void ) ds ; out = ( NeDsMethodOutput
* ) allocator -> mCallocFcn ( allocator , sizeof ( NeDsMethodOutput ) , 1 ) ;
out -> mM . mN = 0 ; out -> mM . mX = ( real_T * ) allocator -> mCallocFcn (
allocator , sizeof ( real_T ) , 0 ) ; return out ; } static NeDsMethodOutput
* ds_output_vmm ( const NeDynamicSystem * ds , NeAllocator * allocator ) {
NeDsMethodOutput * out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator
-> mCallocFcn ( allocator , sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mVMM .
mN = 0 ; out -> mVMM . mX = ( boolean_T * ) allocator -> mCallocFcn (
allocator , sizeof ( boolean_T ) , 0 ) ; return out ; } static
NeDsMethodOutput * ds_output_dxm_p ( const NeDynamicSystem * ds , NeAllocator
* allocator ) { NeDsMethodOutput * out ; ( void ) ds ; out = (
NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator , sizeof (
NeDsMethodOutput ) , 1 ) ; out -> mDXM_P . mNumCol = 1 ; out -> mDXM_P .
mNumRow = 0 ; out -> mDXM_P . mJc = ( int32_T * ) allocator -> mCallocFcn (
allocator , sizeof ( int32_T ) , 2 ) ; out -> mDXM_P . mIr = ( int32_T * )
...
mNumRow = 0 ; out -> mDUM_P . mJc = ( int32_T * ) allocator -> mCallocFcn (
...
mNumRow = 0 ; out -> mDTM_P . mJc = ( int32_T * ) allocator -> mCallocFcn (
...
, NeAllocator * allocator ) { NeDsMethodOutput * out ; ( void ) ds ; out = (
NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator , sizeof (
NeDsMethodOutput ) , 1 ) ; out -> mA_P . mNumCol = 1 ; out -> mA_P . mNumRow
= 1 ; out -> mA_P . mJc = ( int32_T * ) allocator -> mCallocFcn ( allocator ,
sizeof ( int32_T ) , 2 ) ; out -> mA_P . mIr = ( int32_T * ) allocator ->
mCallocFcn ( allocator , sizeof ( int32_T ) , 1 ) ; return out ; } static
NeDsMethodOutput * ds_output_a ( const NeDynamicSystem * ds , NeAllocator *
allocator ) { NeDsMethodOutput * out ; ( void ) ds ; out = ( NeDsMethodOutput
* ) allocator -> mCallocFcn ( allocator , sizeof ( NeDsMethodOutput ) , 1 ) ;
out -> mA . mN = 1 ; out -> mA . mX = ( real_T * ) allocator -> mCallocFcn (
allocator , sizeof ( real_T ) , 1 ) ; return out ; } static NeDsMethodOutput
* ds_output_b_p ( const NeDynamicSystem * ds , NeAllocator * allocator ) {
NeDsMethodOutput * out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator
-> mCallocFcn ( allocator , sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mB_P .
mNumCol = 1 ; out -> mB_P . mNumRow = 1 ; out -> mB_P . mJc = ( int32_T * )
allocator -> mCallocFcn ( allocator , sizeof ( int32_T ) , 2 ) ; out -> mB_P
. mIr = ( int32_T * ) allocator -> mCallocFcn ( allocator , sizeof ( int32_T
) , 1 ) ; return out ; } static NeDsMethodOutput * ds_output_b ( const
NeDynamicSystem * ds , NeAllocator * allocator ) { NeDsMethodOutput * out ; (
void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator
, sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mB . mN = 1 ; out -> mB . mX = (
...
. mNumRow = 1 ; out -> mC_P . mJc = ( int32_T * ) allocator -> mCallocFcn (
...
NeAllocator * allocator ) { NeDsMethodOutput * out ; ( void ) ds ; out = (
NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator , sizeof (
NeDsMethodOutput ) , 1 ) ; out -> mF . mN = 1 ; out -> mF . mX = ( real_T * )
allocator -> mCallocFcn ( allocator , sizeof ( real_T ) , 1 ) ; return out ;
} static NeDsMethodOutput * ds_output_vmf ( const NeDynamicSystem * ds ,
NeAllocator * allocator ) { NeDsMethodOutput * out ; ( void ) ds ; out = (
NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator , sizeof (
NeDsMethodOutput ) , 1 ) ; out -> mVMF . mN = 1 ; out -> mVMF . mX = (
boolean_T * ) allocator -> mCallocFcn ( allocator , sizeof ( boolean_T ) , 1
) ; return out ; } static NeDsMethodOutput * ds_output_slf ( const
NeDynamicSystem * ds , NeAllocator * allocator ) { NeDsMethodOutput * out ; (
void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator
, sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mSLF . mN = 1 ; out -> mSLF . mX
= ( boolean_T * ) allocator -> mCallocFcn ( allocator , sizeof ( boolean_T )
, 1 ) ; return out ; } static NeDsMethodOutput * ds_output_dxf_p ( const
NeDynamicSystem * ds , NeAllocator * allocator ) { NeDsMethodOutput * out ; (
void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator
, sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mDXF_P . mNumCol = 1 ; out ->
mDXF_P . mNumRow = 1 ; out -> mDXF_P . mJc = ( int32_T * ) allocator ->
mCallocFcn ( allocator , sizeof ( int32_T ) , 2 ) ; out -> mDXF_P . mIr = (
...
mDUF_P . mNumRow = 1 ; out -> mDUF_P . mJc = ( int32_T * ) allocator ->
...
mDTF_P . mNumRow = 1 ; out -> mDTF_P . mJc = ( int32_T * ) allocator ->
...
mDDF_P . mNumRow = 1 ; out -> mDDF_P . mJc = ( int32_T * ) allocator ->
...
mTDUF_P . mNumRow = 1 ; out -> mTDUF_P . mJc = ( int32_T * ) allocator ->
...
NeDynamicSystem * ds , NeAllocator * allocator ) { NeDsMethodOutput * out ; (
void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator
, sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mTDXF_P . mNumCol = 1 ; out ->
mTDXF_P . mNumRow = 1 ; out -> mTDXF_P . mJc = ( int32_T * ) allocator ->
mCallocFcn ( allocator , sizeof ( int32_T ) , 2 ) ; out -> mTDXF_P . mIr = (
int32_T * ) allocator -> mCallocFcn ( allocator , sizeof ( int32_T ) , 1 ) ;
...
NeAllocator * allocator ) { NeDsMethodOutput * out ; ( void ) ds ; out = (
NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator , sizeof (
NeDsMethodOutput ) , 1 ) ; out -> mDXY_P . mNumCol = 1 ; out -> mDXY_P .
mNumRow = 1 ; out -> mDXY_P . mJc = ( int32_T * ) allocator -> mCallocFcn (
allocator , sizeof ( int32_T ) , 2 ) ; out -> mDXY_P . mIr = ( int32_T * )
allocator -> mCallocFcn ( allocator , sizeof ( int32_T ) , 1 ) ; return out ;
} static NeDsMethodOutput * ds_output_dxy ( const NeDynamicSystem * ds ,
NeAllocator * allocator ) { NeDsMethodOutput * out ; ( void ) ds ; out = (
NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator , sizeof (
...
* ds , NeAllocator * allocator ) { NeDsMethodOutput * out ; ( void ) ds ; out
= ( NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator , sizeof (
NeDsMethodOutput ) , 1 ) ; out -> mR . mN = 1 ; out -> mR . mX = ( real_T * )
allocator -> mCallocFcn ( allocator , sizeof ( real_T ) , 1 ) ; return out ;
...
NeDsMethodOutput * out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator
-> mCallocFcn ( allocator , sizeof ( NeDsMethodOutput ) , 1 ) ; out ->
mDXDELT_P . mNumCol = 1 ; out -> mDXDELT_P . mNumRow = 0 ; out -> mDXDELT_P .
mJc = ( int32_T * ) allocator -> mCallocFcn ( allocator , sizeof ( int32_T )
, 2 ) ; out -> mDXDELT_P . mIr = ( int32_T * ) allocator -> mCallocFcn (
...
; } NeDynamicSystem * friccion_aislada_esferica_e48f9f4d_1_dae_ds (
...
mNumVariables = 1 ; ds -> mNumDiscreteRealVariables = 0 ; ds ->
mNumDifferentialVariables = 0 ; ds -> mNumEquations = 1 ; ds -> mNumModes = 0
; ds -> mNumMajorModes = 0 ; ds -> mNumCache = 0 ; ds -> mNumZcs = 0 ; ds ->
mNumAsserts = 0 ; ds -> mNumAssertRanges = 0 ; ds -> mNumRanges = 0 ; ds ->
mNumEquationRanges = 1 ; ds -> mNumFundamentalSamples = 0 ; ds -> mNumDelays
= 0 ; ds -> mIsOutputLinear = 1 ; ds -> mNumIo [ NE_INPUT_IO_TYPE ] = 1 ;
input_info [ 0 ] . mIdentifier =
"friccion_aislada_esferica/Robot Delta/PS Gain2_" ; input_info [ 0 ] . mM = 1
; input_info [ 0 ] . mN = 1 ; input_info [ 0 ] . mName =
"Robot_Delta.PS_Gain2.I" ; input_info [ 0 ] . mUnit = "1" ; ds -> mIo [
NE_INPUT_IO_TYPE ] = input_info ; ds -> mNumIo [ NE_OUTPUT_IO_TYPE ] = 1 ;
output_info [ 0 ] . mIdentifier =
"friccion_aislada_esferica/Robot Delta/PS Gain2_" ; output_info [ 0 ] . mM =
1 ; output_info [ 0 ] . mN = 1 ; output_info [ 0 ] . mName =
"Robot_Delta.PS_Gain2.O" ; output_info [ 0 ] . mUnit = "1" ; ds -> mIo [
...
NE_DS_METHOD_DXF ] = stub_method ; ds -> mMakeOutput [ NE_DS_METHOD_DXF ] =
