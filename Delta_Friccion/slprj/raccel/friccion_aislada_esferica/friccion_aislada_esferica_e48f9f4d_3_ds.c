...
#include "ne_ds.h"
#include "friccion_aislada_esferica_e48f9f4d_3_ds.h"
...
"friccion_aislada_esferica.Robot_Delta.PS_Gain" , 0U , 8 ,
NE_EQUATION_DOMAIN_TIME , "friccion_aislada_esferica/Robot Delta/PS Gain" ,
1U , 0U , TRUE , 1.0 } } ; static NeVariableData s_variable_data [ 1 ] = { {
"friccion_aislada_esferica.Robot_Delta.PS_Gain.O" , 0U , 2 ,
"friccion_aislada_esferica/Robot Delta/PS Gain" , 1.0 , "1" , 0.0 , FALSE ,
...
; } NeDynamicSystem * friccion_aislada_esferica_e48f9f4d_3_dae_ds (
...
"friccion_aislada_esferica/Robot Delta/PS Gain_" ; input_info [ 0 ] . mM = 1
; input_info [ 0 ] . mN = 1 ; input_info [ 0 ] . mName =
"Robot_Delta.PS_Gain.I" ; input_info [ 0 ] . mUnit = "1" ; ds -> mIo [
NE_INPUT_IO_TYPE ] = input_info ; ds -> mNumIo [ NE_OUTPUT_IO_TYPE ] = 1 ;
output_info [ 0 ] . mIdentifier =
"friccion_aislada_esferica/Robot Delta/PS Gain_" ; output_info [ 0 ] . mM = 1
; output_info [ 0 ] . mN = 1 ; output_info [ 0 ] . mName =
"Robot_Delta.PS_Gain.O" ; output_info [ 0 ] . mUnit = "1" ; ds -> mIo [
