...
inputDdot , const double * discreteState , double * deriv ,
...
( "sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'friccion_aislada_esferica/Robot Delta/Spherical1' has a degenerate mass distribution on its follower side."
...
"sm:compiler:messages:simulationErrors:DegenerateMass" ,
 "'friccion_aislada_esferica/Robot Delta/Spherical3' has a degenerate mass distribution on its follower side."
