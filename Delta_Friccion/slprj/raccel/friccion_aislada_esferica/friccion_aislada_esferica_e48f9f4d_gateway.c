...
#include "nesl_rtw.h"
#include "friccion_aislada_esferica_e48f9f4d_1.h"
#include "friccion_aislada_esferica_e48f9f4d_2.h"
#include "friccion_aislada_esferica_e48f9f4d_3.h"
#include "friccion_aislada_esferica_e48f9f4d_4.h"
void friccion_aislada_esferica_e48f9f4d_gateway ( void ) { NeModelParameters
...
neu_get_csparse_linear_algebra ( ) ) ; NeDae * dae [ 4 ] ; size_t numInputs =
...
friccion_aislada_esferica_e48f9f4d_1_dae ( & dae [ 0 ] , & modelparams , &
solverparams , linear_algebra_ptr ) ;
friccion_aislada_esferica_e48f9f4d_2_dae ( & dae [ 1 ] , & modelparams , &
solverparams , linear_algebra_ptr ) ;
friccion_aislada_esferica_e48f9f4d_3_dae ( & dae [ 2 ] , & modelparams , &
solverparams , linear_algebra_ptr ) ;
friccion_aislada_esferica_e48f9f4d_4_dae ( & dae [ 3 ] , & modelparams , &
solverparams , linear_algebra_ptr ) ; nesl_register_simulator_group (
"friccion_aislada_esferica/Robot Delta/Solver Configuration" , 4 , dae ,
solverparams , modelparams , numInputs , inputparameters , numOutputs ,
outputparameters ) ; }
