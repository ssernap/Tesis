...
NeEquationData s_equation_data [ 9 ] = { {
 "friccion_aislada_esferica_Simscape_Symmechanics.Robot_Delta.Rotational_Friction"
...
, 0U , 8 , NE_EQUATION_DOMAIN_TIME ,
 "friccion_aislada_esferica_Simscape_Symmechanics/Robot Delta/Rotational Friction"
, 1U , 1U , FALSE , 0.00040011984590184461 } , {
 "friccion_aislada_esferica_Simscape_Symmechanics.Robot_Delta.Mechanical_Rotational_Reference"
, 0U , 8 , NE_EQUATION_DOMAIN_TIME ,
 "friccion_aislada_esferica_Simscape_Symmechanics/Robot Delta/Mechanical Rotational Reference"
, 1U , 2U , TRUE , 1.0 } , {
 "friccion_aislada_esferica_Simscape_Symmechanics.Robot_Delta.Rotational_Simscape_Intf.Ideal_Torque_Sensor"
, 0U , 8 , NE_EQUATION_DOMAIN_TIME ,
 "friccion_aislada_esferica_Simscape_Symmechanics/Robot Delta/Rotational Simscape Intf/Ideal Torque Sensor"
, 1U , 3U , TRUE , 1.0 } , {
 "friccion_aislada_esferica_Simscape_Symmechanics.Robot_Delta.Rotational_Simscape_Intf.Ideal_Torque_Sensor"
, 0U , 8 , NE_EQUATION_DOMAIN_TIME ,
 "friccion_aislada_esferica_Simscape_Symmechanics/Robot Delta/Rotational Simscape Intf/Ideal Torque Sensor"
...
, 0U , 8 , NE_EQUATION_DOMAIN_TIME ,
 "friccion_aislada_esferica_Simscape_Symmechanics/Robot Delta/Rotational Simscape Intf/Ideal Torque Sensor"
, 1U , 5U , TRUE , 1.0 } , {
 "friccion_aislada_esferica_Simscape_Symmechanics.Robot_Delta.Rotational_Simscape_Intf.Ideal_Angular_Velocity_Source"
, 0U , 8 , NE_EQUATION_DOMAIN_TIME ,
 "friccion_aislada_esferica_Simscape_Symmechanics/Robot Delta/Rotational Simscape Intf/Ideal Angular Velocity Source"
, 1U , 6U , TRUE , 1.0 } , {
 "friccion_aislada_esferica_Simscape_Symmechanics.Robot_Delta.Rotational_Simscape_Intf.Ideal_Angular_Velocity_Source"
, 0U , 8 , NE_EQUATION_DOMAIN_TIME ,
 "friccion_aislada_esferica_Simscape_Symmechanics/Robot Delta/Rotational Simscape Intf/Ideal Angular Velocity Source"
, 1U , 7U , TRUE , 1.0 } , {
 "friccion_aislada_esferica_Simscape_Symmechanics.Robot_Delta.Mechanical_Rotational_Reference_W"
...
{
 "friccion_aislada_esferica_Simscape_Symmechanics.Robot_Delta.Mechanical_Rotational_Reference.t"
, 0U , 0 ,
 "friccion_aislada_esferica_Simscape_Symmechanics/Robot Delta/Mechanical Rotational Reference"
, 1.0 , "N*m" , 0.0 , FALSE , FALSE , 1U , 1U , NE_INIT_MODE_NONE , "Torque"
} , {
 "friccion_aislada_esferica_Simscape_Symmechanics.Robot_Delta.Rotational_Friction.C.w"
, 0U , 1 ,
 "friccion_aislada_esferica_Simscape_Symmechanics/Robot Delta/Rotational Friction"
, 1.0 , "rad/s" , 0.0 , FALSE , FALSE , 1U , 1U , NE_INIT_MODE_NONE , "w" } ,
{
 "friccion_aislada_esferica_Simscape_Symmechanics.Robot_Delta.Rotational_Friction.R.w"
, 0U , 1 ,
 "friccion_aislada_esferica_Simscape_Symmechanics/Robot Delta/Rotational Friction"
, 1.0 , "rad/s" , 0.0 , FALSE , FALSE , 1U , 1U , NE_INIT_MODE_NONE , "w" } ,
{
...
"Torque" } , {
 "friccion_aislada_esferica_Simscape_Symmechanics.Robot_Delta.Rotational_Friction.w"
, 0U , 0 ,
 "friccion_aislada_esferica_Simscape_Symmechanics/Robot Delta/Rotational Friction"
, 1.0 , "rad/s" , 0.0 , FALSE , FALSE , 1U , 1U , NE_INIT_MODE_MANDATORY ,
"Rotational velocity" } , {
 "friccion_aislada_esferica_Simscape_Symmechanics.Robot_Delta.Rotational_Simscape_Intf.Ideal_Angular_Velocity_Source.w"
, 0U , 0 ,
 "friccion_aislada_esferica_Simscape_Symmechanics/Robot Delta/Rotational Simscape Intf/Ideal Angular Velocity Source"
, 1.0 , "rad/s" , 0.0 , FALSE , FALSE , 1U , 1U , NE_INIT_MODE_NONE ,
"Angular velocity" } , {
 "friccion_aislada_esferica_Simscape_Symmechanics.Robot_Delta.Rotational_Simscape_Intf.Ideal_Torque_Sensor.R.w"
, 0U , 1 ,
 "friccion_aislada_esferica_Simscape_Symmechanics/Robot Delta/Rotational Simscape Intf/Ideal Torque Sensor"
, 1.0 , "rad/s" , 0.0 , FALSE , FALSE , 1U , 1U , NE_INIT_MODE_NONE , "w" } ,
{
 "friccion_aislada_esferica_Simscape_Symmechanics.Robot_Delta.Rotational_Simscape_Intf.Ideal_Torque_Sensor.w"
, 0U , 0 ,
 "friccion_aislada_esferica_Simscape_Symmechanics/Robot Delta/Rotational Simscape Intf/Ideal Torque Sensor"
, 1.0 , "rad/s" , 0.0 , FALSE , FALSE , 1U , 1U , NE_INIT_MODE_NONE ,
"Angular velocity" } , {
 "friccion_aislada_esferica_Simscape_Symmechanics.Robot_Delta.Rotational_Simscape_Intf.Ideal_Torque_Sensor.T"
, 0U , 2 ,
 "friccion_aislada_esferica_Simscape_Symmechanics/Robot Delta/Rotational\nSimscape Intf/Ideal Torque Sensor"
...
X_idx_4 - 0.1 - 0.15 * exp ( - 5.0 * ( ( boolean_T ) M_idx_2 ? X_idx_4 : -
X_idx_4 ) ) ; t9 = ( boolean_T ) M_idx_1 ? X_idx_3 - ( 0.001 * X_idx_4 + 0.1
+ 0.15 * exp ( - 5.0 * X_idx_4 ) ) : X_idx_3 - t9 ; local0 . mX [ 0ULL ] = x
[ 0ULL ] ; local0 . mX [ 1ULL ] = 0.00040011984590184461 * ( ( boolean_T )
M_idx_0 ? X_idx_3 - 0.2499251187468754 * X_idx_4 / 0.0001 : t9 ) ; local0 .
mX [ 2ULL ] = x [ 2ULL ] ; local0 . mX [ 3ULL ] = x [ 3ULL ] ; local0 . mX [
4ULL ] = x [ 4ULL ] ; local0 . mX [ 5ULL ] = x [ 5ULL ] ; local0 . mX [ 6ULL
] = x [ 6ULL ] ; local0 . mX [ 7ULL ] = x [ 7ULL ] ; local0 . mX [ 8ULL ] = x
[ 8ULL ] ; ( void ) ds ; ( void ) in ; return 0 ; } static int32_T ds_vmf (
const NeDynamicSystem * ds , const NeDynamicSystemInput * in ,
NeDsMethodOutput * out1 ) { NeBoolVector local0 ; boolean_T x [ 9 ] ; size_t
idx ; ( void ) in ; local0 = out1 -> mVMF ; for ( idx = 0ULL ; idx < 9ULL ;
idx ++ ) { x [ idx ] = false ; } local0 . mX [ 0 ] = x [ 0 ] ; local0 . mX [
1 ] = true ; local0 . mX [ 2 ] = x [ 2 ] ; local0 . mX [ 3 ] = x [ 3 ] ;
local0 . mX [ 4 ] = x [ 4 ] ; local0 . mX [ 5 ] = x [ 5 ] ; local0 . mX [ 6 ]
= x [ 6 ] ; local0 . mX [ 7 ] = x [ 7 ] ; local0 . mX [ 8 ] = x [ 8 ] ; (
void ) ds ; ( void ) in ; return 0 ; } static int32_T ds_slf ( const
NeDynamicSystem * ds , const NeDynamicSystemInput * in , NeDsMethodOutput *
out1 ) { NeBoolVector local0 ; boolean_T x [ 9 ] ; size_t idx ; ( void ) in ;
local0 = out1 -> mSLF ; for ( idx = 0ULL ; idx < 9ULL ; idx ++ ) { x [ idx ]
= false ; } local0 . mX [ 0 ] = x [ 0 ] ; local0 . mX [ 1 ] = x [ 1 ] ;
local0 . mX [ 2 ] = x [ 2 ] ; local0 . mX [ 3 ] = x [ 3 ] ; local0 . mX [ 4 ]
= x [ 4 ] ; local0 . mX [ 5 ] = x [ 5 ] ; local0 . mX [ 6 ] = x [ 6 ] ;
local0 . mX [ 7 ] = x [ 7 ] ; local0 . mX [ 8 ] = x [ 8 ] ; ( void ) ds ; (
void ) in ; return 0 ; } static int32_T ds_dxf_p ( const NeDynamicSystem * ds
, const NeDynamicSystemInput * in , NeDsMethodOutput * out1 ) {
NeSparsityPattern local0 ; ( void ) in ; local0 = out1 -> mDXF_P ; local0 .
mJc [ 0ULL ] = 0 ; local0 . mJc [ 1ULL ] = 0 ; local0 . mJc [ 2ULL ] = 0 ;
local0 . mJc [ 3ULL ] = 0 ; local0 . mJc [ 4ULL ] = 1 ; local0 . mJc [ 5ULL ]
= 2 ; local0 . mJc [ 6ULL ] = 2 ; local0 . mJc [ 7ULL ] = 2 ; local0 . mJc [
8ULL ] = 2 ; local0 . mJc [ 9ULL ] = 2 ; local0 . mIr [ 0ULL ] = 1 ; local0 .
mIr [ 1ULL ] = 1 ; ( void ) ds ; ( void ) in ; return 0 ; } static int32_T
ds_dxf ( const NeDynamicSystem * ds , const NeDynamicSystemInput * in ,
NeDsMethodOutput * out1 ) { NeRealVector local0 ; real_T t8 ; int32_T M_idx_0
; int32_T M_idx_1 ; int32_T M_idx_2 ; real_T X_idx_4 ; M_idx_0 = in -> mM .
mX [ 0 ] ; M_idx_1 = in -> mM . mX [ 1 ] ; M_idx_2 = in -> mM . mX [ 2 ] ;
X_idx_4 = in -> mX . mX [ 4 ] ; local0 = out1 -> mDXF ; t8 = exp ( - 5.0 * (
( boolean_T ) M_idx_2 ? X_idx_4 : - X_idx_4 ) ) * ( - 5.0 * ( ( boolean_T )
M_idx_2 ? 1.0 : - 1.0 ) ) ; X_idx_4 = ( boolean_T ) M_idx_1 ? - ( 0.001 +
0.15 * ( exp ( - 5.0 * X_idx_4 ) * - 5.0 ) ) : - ( 0.001 - 0.15 * t8 ) ; t8 =
1.0E-8 ; local0 . mX [ 0ULL ] = 0.00040011984590184461 ; local0 . mX [ 1ULL ]
= ( ( boolean_T ) M_idx_0 ? - ( 2.4992511874687541E-5 / ( t8 == 0.0 ? 1.0E-16
: t8 ) ) : X_idx_4 ) * 0.00040011984590184461 ; ( void ) ds ; ( void ) in ;
return 0 ; } static int32_T ds_duf_p ( const NeDynamicSystem * ds , const
NeDynamicSystemInput * in , NeDsMethodOutput * out1 ) { NeSparsityPattern
