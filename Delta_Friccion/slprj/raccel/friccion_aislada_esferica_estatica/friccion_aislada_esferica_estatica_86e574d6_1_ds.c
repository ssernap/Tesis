...
#include "ne_ds.h"
#include "friccion_aislada_esferica_estatica_86e574d6_1_ds.h"
...
"friccion_aislada_esferica_estatica.Robot_Delta.PS_Gain2" , 0U , 8 ,
NE_EQUATION_DOMAIN_TIME ,
"friccion_aislada_esferica_estatica/Robot Delta/PS Gain2" , 1U , 0U , TRUE ,
1.0 } , { "friccion_aislada_esferica_estatica.Robot_Delta.PS_Sign" , 0U , 8 ,
NE_EQUATION_DOMAIN_TIME ,
"friccion_aislada_esferica_estatica/Robot Delta/PS Sign" , 1U , 1U , TRUE ,
1.0 } } ; static NeVariableData s_variable_data [ 2 ] = { {
"friccion_aislada_esferica_estatica.Robot_Delta.PS_Sign.O" , 0U , 2 ,
"friccion_aislada_esferica_estatica/Robot Delta/PS Sign" , 1.0 , "1" , 0.0 ,
FALSE , FALSE , 1U , 1U , NE_INIT_MODE_NONE , "O" } , {
"friccion_aislada_esferica_estatica.Robot_Delta.PS_Gain2.O" , 0U , 2 ,
"friccion_aislada_esferica_estatica/Robot Delta/PS Gain2" , 1.0 , "1" , 0.0 ,
...
"friccion_aislada_esferica_estatica/Robot Delta/PS Sign" , 1U , 0U ,
"friccion_aislada_esferica_estatica.Robot_Delta.PS_Sign" , "PS Sign" ,
NE_ZC_TYPE_FALSE } , {
"friccion_aislada_esferica_estatica/Robot Delta/PS Sign" , 1U , 1U ,
"friccion_aislada_esferica_estatica.Robot_Delta.PS_Sign" , "PS Sign" ,
...
; } NeDynamicSystem * friccion_aislada_esferica_estatica_86e574d6_1_dae_ds (
...
"friccion_aislada_esferica_estatica/Robot Delta/PS Sign_" ; input_info [ 0 ]
. mM = 1 ; input_info [ 0 ] . mN = 1 ; input_info [ 0 ] . mName =
"Robot_Delta.PS_Sign.I" ; input_info [ 0 ] . mUnit = "1" ; ds -> mIo [
NE_INPUT_IO_TYPE ] = input_info ; ds -> mNumIo [ NE_OUTPUT_IO_TYPE ] = 1 ;
output_info [ 0 ] . mIdentifier =
"friccion_aislada_esferica_estatica/Robot Delta/PS Gain2_" ; output_info [ 0
