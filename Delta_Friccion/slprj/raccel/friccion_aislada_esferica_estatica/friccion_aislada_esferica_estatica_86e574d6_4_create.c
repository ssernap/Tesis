...
friccion_aislada_esferica_estatica_86e574d6_4_outputDyn ( const double * ,
const double * , const double * , const double * , const double * , double *
, double * , int * , NeuDiagnosticManager * neDiagMgr ) ; PmfMessageId
friccion_aislada_esferica_estatica_86e574d6_4_outputKin ( const double * ,
const double * , const double * , const double * , const double * , double *
, NeuDiagnosticManager * neDiagMgr ) ; PmfMessageId
friccion_aislada_esferica_estatica_86e574d6_4_output ( const double * , const
double * , const double * , const double * , const double * , double * ,
NeuDiagnosticManager * neDiagMgr ) ; PmfMessageId
friccion_aislada_esferica_estatica_86e574d6_4_project ( const double * ,
const double * , const double * , double * , double * , NeuDiagnosticManager
* neDiagMgr ) ; void
friccion_aislada_esferica_estatica_86e574d6_4_resetStateVector ( const void *
mech , double * stateVector ) ; PmfMessageId
friccion_aislada_esferica_estatica_86e574d6_4_initializeTrackedAngleState (
const void * mech , double * stateVector , void * neDiagMgr ) ; void
friccion_aislada_esferica_estatica_86e574d6_4_computeDiscreteState ( const
void * mech , double * stateVector ) ; void
friccion_aislada_esferica_estatica_86e574d6_4_adjustPosition ( const void *
mech , const double * dofDeltas , double * stateVector ) ; void
friccion_aislada_esferica_estatica_86e574d6_4_perturbState ( const void *
mech , size_t stageIdx , size_t primitiveIdx , double magnitude , boolean_T
doPerturbVelocity , double * stateVector ) ; void
friccion_aislada_esferica_estatica_86e574d6_4_propagateMotion ( const void *
mech , const double * stateVector , double * motionData ) ; size_t
friccion_aislada_esferica_estatica_86e574d6_4_computeAssemblyError ( const
void * mech , size_t constraintIdx , const double * stateVector , const
double * motionData , double * error ) ; size_t
friccion_aislada_esferica_estatica_86e574d6_4_computeAssemblyJacobian ( const
...
size_t
friccion_aislada_esferica_estatica_86e574d6_4_computeFullAssemblyJacobian (
const void * mech , const double * stateVector , const double * motionData ,
double * J ) ; PmfMessageId
friccion_aislada_esferica_estatica_86e574d6_4_convertStateVector ( const void
* asmMech , const void * simMech , const double * asmStateVector , double *
simStateVector , void * neDiagMgr ) ; PmfMessageId
friccion_aislada_esferica_estatica_86e574d6_4_assemble ( const double * u ,
...
daeMethodOutput -> mXP0 . mX , smData -> mCachedDerivatives . mX , 14 *
sizeof ( real_T ) ) ; else errorId =
friccion_aislada_esferica_estatica_86e574d6_4_deriv ( systemInput -> mX . mX
, systemInput -> mU . mX , systemInput -> mU . mX + 6 , systemInput -> mV .
mX + 6 , systemInput -> mD . mX , daeMethodOutput -> mXP0 . mX , neDiagMgr )
; return errorId ; } static PmfMessageId dae_output_method ( const NeDae *
...
dae ; errorId = friccion_aislada_esferica_estatica_86e574d6_4_output (
...
; return friccion_aislada_esferica_estatica_86e574d6_4_project ( systemInput
-> mU . mX , systemInput -> mU . mX + 6 , systemInput -> mD . mX ,
systemInput -> mX . mX , & fullStateVal , neDiagMgr ) ; } static PmfMessageId
...
"friccion_aislada_esferica_estatica/Robot Delta/Spherical3" ,
"friccion_aislada_esferica_estatica/Robot Delta/Spherical3" ,
"friccion_aislada_esferica_estatica/Robot Delta/Spherical3" } ; smData ->
...
friccion_aislada_esferica_estatica_86e574d6_4_resetStateVector ; asmDelegate
-> mInitializeTrackedAngleState =
friccion_aislada_esferica_estatica_86e574d6_4_initializeTrackedAngleState ;
asmDelegate -> mComputeDiscreteState =
friccion_aislada_esferica_estatica_86e574d6_4_computeDiscreteState ;
asmDelegate -> mAdjustPosition =
friccion_aislada_esferica_estatica_86e574d6_4_adjustPosition ; asmDelegate ->
mPerturbState = friccion_aislada_esferica_estatica_86e574d6_4_perturbState ;
asmDelegate -> mPropagateMotion =
friccion_aislada_esferica_estatica_86e574d6_4_propagateMotion ; asmDelegate
-> mComputeAssemblyError =
friccion_aislada_esferica_estatica_86e574d6_4_computeAssemblyError ;
asmDelegate -> mComputeAssemblyJacobian =
friccion_aislada_esferica_estatica_86e574d6_4_computeAssemblyJacobian ;
asmDelegate -> mComputeFullAssemblyJacobian =
friccion_aislada_esferica_estatica_86e574d6_4_computeFullAssemblyJacobian ;
asmDelegate -> mConvertStateVector =
friccion_aislada_esferica_estatica_86e574d6_4_convertStateVector ;
