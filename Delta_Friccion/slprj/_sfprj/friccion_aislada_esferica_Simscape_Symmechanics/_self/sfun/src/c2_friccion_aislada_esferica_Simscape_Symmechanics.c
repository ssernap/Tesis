...
#include "c2_friccion_aislada_esferica_Simscape_Symmechanics.h"
...
static void initialize_c2_friccion_aislada_esferica_Simscape_Symmechanics
  (SFc2_friccion_aislada_esferica_Simscape_SymmechanicsInstanceStruct
   *chartInstance);
static void initialize_params_c2_friccion_aislada_esferica_Simscape_Symmechanics
  (SFc2_friccion_aislada_esferica_Simscape_SymmechanicsInstanceStruct
   *chartInstance);
static void enable_c2_friccion_aislada_esferica_Simscape_Symmechanics
  (SFc2_friccion_aislada_esferica_Simscape_SymmechanicsInstanceStruct
   *chartInstance);
static void disable_c2_friccion_aislada_esferica_Simscape_Symmechanics
  (SFc2_friccion_aislada_esferica_Simscape_SymmechanicsInstanceStruct
   *chartInstance);
static void c2_update_debugger_state_c2_friccion_aislada_esferica_Simscape_S
  (SFc2_friccion_aislada_esferica_Simscape_SymmechanicsInstanceStruct
   *chartInstance);
static const mxArray
  *get_sim_state_c2_friccion_aislada_esferica_Simscape_Symmechanics
  (SFc2_friccion_aislada_esferica_Simscape_SymmechanicsInstanceStruct
   *chartInstance);
static void set_sim_state_c2_friccion_aislada_esferica_Simscape_Symmechanics
  (SFc2_friccion_aislada_esferica_Simscape_SymmechanicsInstanceStruct
   *chartInstance, const mxArray *c2_st);
static void finalize_c2_friccion_aislada_esferica_Simscape_Symmechanics
  (SFc2_friccion_aislada_esferica_Simscape_SymmechanicsInstanceStruct
   *chartInstance);
static void sf_gateway_c2_friccion_aislada_esferica_Simscape_Symmechanics
  (SFc2_friccion_aislada_esferica_Simscape_SymmechanicsInstanceStruct
   *chartInstance);
static void c2_chartstep_c2_friccion_aislada_esferica_Simscape_Symmechanics
  (SFc2_friccion_aislada_esferica_Simscape_SymmechanicsInstanceStruct
   *chartInstance);
static void initSimStructsc2_friccion_aislada_esferica_Simscape_Symmechanics
  (SFc2_friccion_aislada_esferica_Simscape_SymmechanicsInstanceStruct
   *chartInstance);
...
static uint8_T c2_d_emlrt_marshallIn
   ...
   *c2_b_is_active_c2_friccion_aislada_esferica_Simscape_Symmechanic, const
   ...
   *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_friccion_aislada_esferica_Simscape_Symmechanics
    = 0U;
}
   ...
   *chartInstance, const mxArray *c2_st)
{
  ...
  *c2_PosZ = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u,
  ...
  chartInstance->c2_is_active_c2_friccion_aislada_esferica_Simscape_Symmechanics
    ...
    "is_active_c2_friccion_aislada_esferica_Simscape_Symmechanics");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_friccion_aislada_esferica_Simscape_S(chartInstance);
   ...
   *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_friccion_aislada_esferica_Simscape_Symmechanics(chartInstance);
...
const mxArray
  *sf_c2_friccion_aislada_esferica_Simscape_Symmechanics_get_eml_resolved_functions_info
  (void)
{
   ...
   char_T *c2_identifier)
{
  ...
  c2_y = c2_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_friccion_aislada_esferica_Simscape_Symmechanic),
    &c2_thisId);
  sf_mex_destroy
    (&c2_b_is_active_c2_friccion_aislada_esferica_Simscape_Symmechanic);
  return c2_y;
...
void sf_c2_friccion_aislada_esferica_Simscape_Symmechanics_get_check_sum(mxArray
  *plhs[])
{
...
mxArray
  *sf_c2_friccion_aislada_esferica_Simscape_Symmechanics_get_autoinheritance_info
  (void)
{
...
mxArray
  *sf_c2_friccion_aislada_esferica_Simscape_Symmechanics_third_party_uses_info
  (void)
{
...
mxArray
  *sf_c2_friccion_aislada_esferica_Simscape_Symmechanics_updateBuildInfo_args_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c2_friccion_aislada_esferica_Simscape_Symmechanics(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"PosX\",},{M[1],M[6],T\"PosY\",},{M[1],M[7],T\"PosZ\",},{M[8],M[0],T\"is_active_c2_friccion_aislada_esferica_Simscape_Symmechanics\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_friccion_aislada_esferica_Simscape_Symmechanics_get_check_sum
    (&mxChecksum);
...
static void
  sf_opaque_initialize_c2_friccion_aislada_esferica_Simscape_Symmechanics(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc2_friccion_aislada_esferica_Simscape_SymmechanicsInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c2_friccion_aislada_esferica_Simscape_Symmechanics
    ((SFc2_friccion_aislada_esferica_Simscape_SymmechanicsInstanceStruct*)
     chartInstanceVar);
  initialize_c2_friccion_aislada_esferica_Simscape_Symmechanics
    ((SFc2_friccion_aislada_esferica_Simscape_SymmechanicsInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c2_friccion_aislada_esferica_Simscape_Symmechanics
  (void *chartInstanceVar)
{
  enable_c2_friccion_aislada_esferica_Simscape_Symmechanics
    ((SFc2_friccion_aislada_esferica_Simscape_SymmechanicsInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c2_friccion_aislada_esferica_Simscape_Symmechanics
  (void *chartInstanceVar)
{
  disable_c2_friccion_aislada_esferica_Simscape_Symmechanics
    ((SFc2_friccion_aislada_esferica_Simscape_SymmechanicsInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c2_friccion_aislada_esferica_Simscape_Symmechanics
  (void *chartInstanceVar)
{
  sf_gateway_c2_friccion_aislada_esferica_Simscape_Symmechanics
    ((SFc2_friccion_aislada_esferica_Simscape_SymmechanicsInstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c2_friccion_aislada_esferica_Simscape_Symmechanics
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c2_friccion_aislada_esferica_Simscape_Symmechanics();/* state var info */
...
extern void
  sf_internal_set_sim_state_c2_friccion_aislada_esferica_Simscape_Symmechanics
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c2_friccion_aislada_esferica_Simscape_Symmechanics
    ((SFc2_friccion_aislada_esferica_Simscape_SymmechanicsInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c2_friccion_aislada_esferica_Simscape_Symmechanics
  (SimStruct* S)
{
  return
    sf_internal_get_sim_state_c2_friccion_aislada_esferica_Simscape_Symmechanics
...
static void
  sf_opaque_set_sim_state_c2_friccion_aislada_esferica_Simscape_Symmechanics
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_friccion_aislada_esferica_Simscape_Symmechanics(S,
    st);
}

static void
  sf_opaque_terminate_c2_friccion_aislada_esferica_Simscape_Symmechanics(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    ...
    finalize_c2_friccion_aislada_esferica_Simscape_Symmechanics
      ((SFc2_friccion_aislada_esferica_Simscape_SymmechanicsInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc2_friccion_aislada_esferica_Simscape_Symmechanics
    ((SFc2_friccion_aislada_esferica_Simscape_SymmechanicsInstanceStruct*)
     chartInstanceVar);
}
...
static void
  mdlProcessParameters_c2_friccion_aislada_esferica_Simscape_Symmechanics
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_friccion_aislada_esferica_Simscape_Symmechanics
  (SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c2_friccion_aislada_esferica_Simscape_Symmechanics(SimStruct *
  S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_friccion_aislada_esferica_Simscape_Symmechanics
  (SimStruct *S)
{
  SFc2_friccion_aislada_esferica_Simscape_SymmechanicsInstanceStruct
    *chartInstance;
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_friccion_aislada_esferica_Simscape_Symmechanics;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_friccion_aislada_esferica_Simscape_Symmechanics;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_friccion_aislada_esferica_Simscape_Symmechanics;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_friccion_aislada_esferica_Simscape_Symmechanics;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_friccion_aislada_esferica_Simscape_Symmechanics;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_friccion_aislada_esferica_Simscape_Symmechanics;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_friccion_aislada_esferica_Simscape_Symmechanics;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_friccion_aislada_esferica_Simscape_Symmechanics;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c2_friccion_aislada_esferica_Simscape_Symmechanics;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c2_friccion_aislada_esferica_Simscape_Symmechanics;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_friccion_aislada_esferica_Simscape_Symmechanics;
...
void c2_friccion_aislada_esferica_Simscape_Symmechanics_method_dispatcher
  (SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_friccion_aislada_esferica_Simscape_Symmechanics(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_friccion_aislada_esferica_Simscape_Symmechanics(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_friccion_aislada_esferica_Simscape_Symmechanics(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_friccion_aislada_esferica_Simscape_Symmechanics_method_dispatcher.\n"
