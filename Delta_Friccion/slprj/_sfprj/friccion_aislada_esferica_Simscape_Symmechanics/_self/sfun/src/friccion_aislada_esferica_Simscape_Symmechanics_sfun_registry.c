...
{
  extern unsigned int
    sf_friccion_aislada_esferica_Simscape_Symmechanics_process_check_sum_call
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_friccion_aislada_esferica_Simscape_Symmechanics_process_check_sum_call
      (nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName, "friccion_aislada_esferica_Simscape_Symmechanics") ==
      0) {
    ...
    newRhs[2] = prhs[3];
    return
      sf_friccion_aislada_esferica_Simscape_Symmechanics_autoinheritance_info
      (nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_friccion_aislada_esferica_Simscape_Symmechanics_third_party_uses_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
...
{
  if (!strcmp(machineName,"friccion_aislada_esferica_Simscape_Symmechanics")) {
    return(sf_friccion_aislada_esferica_Simscape_Symmechanics_method_dispatcher
...
extern void friccion_aislada_esferica_Simscape_Symmechanics_terminator(void);
void sf_machine_global_terminator(void)
{
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    friccion_aislada_esferica_Simscape_Symmechanics_terminator();
...
extern void friccion_aislada_esferica_Simscape_Symmechanics_initializer(void);
extern void
  friccion_aislada_esferica_Simscape_Symmechanics_register_exported_symbols
  (SimStruct* S);
extern void friccion_aislada_esferica_Simscape_Symmechanics_debug_initialize(
    struct SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  friccion_aislada_esferica_Simscape_Symmechanics_register_exported_symbols(S);
}
