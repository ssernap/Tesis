...
{
  extern unsigned int
    sf_friccion_aislada_esferica_estatica_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_friccion_aislada_esferica_estatica_process_check_sum_call(nlhs,plhs,
       nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int
    sf_friccion_aislada_esferica_estatica_process_testpoint_info_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_friccion_aislada_esferica_estatica_process_testpoint_info_call(nlhs,
       plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
unsigned int sf_process_autoinheritance_call( int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_friccion_aislada_esferica_estatica_autoinheritance_info
  ...
  if (strcmp(machineName, "friccion_aislada_esferica_estatica") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_friccion_aislada_esferica_estatica_autoinheritance_info(nlhs,plhs,
      3,newRhs);
  }
...
{
  extern unsigned int
    sf_friccion_aislada_esferica_estatica_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "friccion_aislada_esferica_estatica") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_friccion_aislada_esferica_estatica_third_party_uses_info(nlhs,plhs,
      3,newRhs);
  }
...
{
  extern unsigned int
    sf_friccion_aislada_esferica_estatica_updateBuildInfo_args_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "friccion_aislada_esferica_estatica") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_friccion_aislada_esferica_estatica_updateBuildInfo_args_info(nlhs,
      plhs,3,newRhs);
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName, "friccion_aislada_esferica_estatica") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_friccion_aislada_esferica_estatica_get_eml_resolved_functions_info
      (nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_friccion_aislada_esferica_estatica_method_dispatcher
  ...
  method, void *data)
{
  if (!strcmp(machineName,"friccion_aislada_esferica_estatica")) {
    return(sf_friccion_aislada_esferica_estatica_method_dispatcher(simstructPtr,
...
extern void friccion_aislada_esferica_estatica_terminator(void);
void sf_machine_global_terminator(void)
{
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    friccion_aislada_esferica_estatica_terminator();
...
extern void friccion_aislada_esferica_estatica_initializer(void);
extern void friccion_aislada_esferica_estatica_register_exported_symbols
  (SimStruct* S);
extern void friccion_aislada_esferica_estatica_debug_initialize(struct
  SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  friccion_aislada_esferica_estatica_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      friccion_aislada_esferica_estatica_debug_initialize
        (sfGlobalDebugInstanceStruct);
    }

    friccion_aislada_esferica_estatica_initializer();
  }
