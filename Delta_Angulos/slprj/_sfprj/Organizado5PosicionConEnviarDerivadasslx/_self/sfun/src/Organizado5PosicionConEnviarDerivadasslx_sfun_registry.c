...
{
  extern unsigned int
    sf_Organizado5PosicionConEnviarDerivadasslx_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_Organizado5PosicionConEnviarDerivadasslx_process_check_sum_call(nlhs,
       plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int
    sf_Organizado5PosicionConEnviarDerivadasslx_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "Organizado5PosicionConEnviarDerivadasslx") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Organizado5PosicionConEnviarDerivadasslx_autoinheritance_info(nlhs,
      plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_Organizado5PosicionConEnviarDerivadasslx_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "Organizado5PosicionConEnviarDerivadasslx") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Organizado5PosicionConEnviarDerivadasslx_third_party_uses_info
      (nlhs,plhs,3,newRhs);
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName, "Organizado5PosicionConEnviarDerivadasslx") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Organizado5PosicionConEnviarDerivadasslx_updateBuildInfo_args_info
      (nlhs,plhs,3,newRhs);
  }
...
extern unsigned int
  sf_Organizado5PosicionConEnviarDerivadasslx_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"Organizado5PosicionConEnviarDerivadasslx")) {
    return(sf_Organizado5PosicionConEnviarDerivadasslx_method_dispatcher
...
extern void Organizado5PosicionConEnviarDerivadasslx_terminator(void);
void sf_machine_global_terminator(void)
{
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    Organizado5PosicionConEnviarDerivadasslx_terminator();
...
extern void Organizado5PosicionConEnviarDerivadasslx_initializer(void);
extern void Organizado5PosicionConEnviarDerivadasslx_register_exported_symbols
  (SimStruct* S);
extern void Organizado5PosicionConEnviarDerivadasslx_debug_initialize(struct
  SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  Organizado5PosicionConEnviarDerivadasslx_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      Organizado5PosicionConEnviarDerivadasslx_debug_initialize
        (sfGlobalDebugInstanceStruct);
    }

    Organizado5PosicionConEnviarDerivadasslx_initializer();
  }
