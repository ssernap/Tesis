...
#include <stddef.h>
#include "blas.h"
#include "Organizado5PosicionConEnviarDerivadasslx_sfun.h"
#include "c2_Organizado5PosicionConEnviarDerivadasslx.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "Organizado5PosicionConEnviarDerivadasslx_sfun_debug_macros.h"
...
static void initialize_c2_Organizado5PosicionConEnviarDerivadasslx
  (SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct *chartInstance);
static void initialize_params_c2_Organizado5PosicionConEnviarDerivadasslx
  (SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct *chartInstance);
static void enable_c2_Organizado5PosicionConEnviarDerivadasslx
  (SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct *chartInstance);
static void disable_c2_Organizado5PosicionConEnviarDerivadasslx
  (SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_Organizado5PosicionConEnviarDerivada
  (SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_Organizado5PosicionConEnviarDerivadasslx
  (SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct *chartInstance);
static void set_sim_state_c2_Organizado5PosicionConEnviarDerivadasslx
  (SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct *chartInstance,
   const mxArray *c2_st);
static void finalize_c2_Organizado5PosicionConEnviarDerivadasslx
  (SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct *chartInstance);
static void sf_gateway_c2_Organizado5PosicionConEnviarDerivadasslx
  (SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct *chartInstance);
static void c2_chartstep_c2_Organizado5PosicionConEnviarDerivadasslx
  (SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct *chartInstance);
static void initSimStructsc2_Organizado5PosicionConEnviarDerivadasslx
  (SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct *chartInstance);
...
static void c2_eml_scalar_eg
  (SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct *chartInstance);
static real_T c2_b_mpower
  (SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct *chartInstance,
   real_T c2_a);
static real_T c2_c_mpower
  (SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct *chartInstance,
   real_T c2_a);
static real_T c2_d_mpower
  (SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct *chartInstance,
   real_T c2_a);
...
static uint8_T c2_d_emlrt_marshallIn
  (SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct *chartInstance,
   const mxArray *c2_b_is_active_c2_Organizado5PosicionConEnviarDerivadasslx,
  ...
  (SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_Organizado5PosicionConEnviarDerivadasslx = 0U;
}
  ...
  (SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct *chartInstance)
{
  ...
  c2_d_hoistedGlobal =
    chartInstance->c2_is_active_c2_Organizado5PosicionConEnviarDerivadasslx;
   ...
   const mxArray *c2_st)
{
  ...
  *c2_PosZ = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u,
  ...
  chartInstance->c2_is_active_c2_Organizado5PosicionConEnviarDerivadasslx =
    ...
    "is_active_c2_Organizado5PosicionConEnviarDerivadasslx");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_Organizado5PosicionConEnviarDerivada(chartInstance);
  ...
  (SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_Organizado5PosicionConEnviarDerivadasslx(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct *chartInstance;
  chartInstance = (SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c2_Organizado5PosicionConEnviarDerivadasslx_get_eml_resolved_functions_info
  (void)
{
   ...
   const char_T *c2_identifier)
{
  ...
  c2_y = c2_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_Organizado5PosicionConEnviarDerivadasslx), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_Organizado5PosicionConEnviarDerivadasslx);
  return c2_y;
}
...
void sf_c2_Organizado5PosicionConEnviarDerivadasslx_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(613836313U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4217656388U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1175482343U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1089691635U);
}

mxArray *sf_c2_Organizado5PosicionConEnviarDerivadasslx_get_autoinheritance_info
  (void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("j4k8qvn5MUuBSp6ecaqByF");
...
mxArray *sf_c2_Organizado5PosicionConEnviarDerivadasslx_third_party_uses_info
  (void)
{
...
mxArray
  *sf_c2_Organizado5PosicionConEnviarDerivadasslx_updateBuildInfo_args_info(void)
{
...
static const mxArray
  *sf_get_sim_state_info_c2_Organizado5PosicionConEnviarDerivadasslx(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"PosX\",},{M[1],M[6],T\"PosY\",},{M[1],M[7],T\"PosZ\",},{M[8],M[0],T\"is_active_c2_Organizado5PosicionConEnviarDerivadasslx\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_Organizado5PosicionConEnviarDerivadasslx_get_check_sum(&mxChecksum);
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_IF(0,1,0,973,986,1022,1654);
        _SFD_CV_INIT_EML_IF(0,1,1,1022,1043,1178,1654);
        _SFD_CV_INIT_EML_IF(0,1,2,1178,1204,1345,1654);
        _SFD_CV_INIT_EML_IF(0,1,3,1345,1375,1518,1654);
...
{
  return "SP00NgsvLkPE75QOuCSHYC";
}

static void sf_opaque_initialize_c2_Organizado5PosicionConEnviarDerivadasslx
  (void *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c2_Organizado5PosicionConEnviarDerivadasslx
    ((SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct*)
     chartInstanceVar);
  initialize_c2_Organizado5PosicionConEnviarDerivadasslx
    ((SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c2_Organizado5PosicionConEnviarDerivadasslx(void
  *chartInstanceVar)
{
  enable_c2_Organizado5PosicionConEnviarDerivadasslx
    ((SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c2_Organizado5PosicionConEnviarDerivadasslx(void
  *chartInstanceVar)
{
  disable_c2_Organizado5PosicionConEnviarDerivadasslx
    ((SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c2_Organizado5PosicionConEnviarDerivadasslx(void
  *chartInstanceVar)
{
  sf_gateway_c2_Organizado5PosicionConEnviarDerivadasslx
    ((SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c2_Organizado5PosicionConEnviarDerivadasslx
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_Organizado5PosicionConEnviarDerivadasslx
    ((SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c2_Organizado5PosicionConEnviarDerivadasslx();/* state var info */
...
extern void
  sf_internal_set_sim_state_c2_Organizado5PosicionConEnviarDerivadasslx
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c2_Organizado5PosicionConEnviarDerivadasslx
    ((SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c2_Organizado5PosicionConEnviarDerivadasslx(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c2_Organizado5PosicionConEnviarDerivadasslx(S);
}

static void sf_opaque_set_sim_state_c2_Organizado5PosicionConEnviarDerivadasslx
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_Organizado5PosicionConEnviarDerivadasslx(S, st);
}

static void sf_opaque_terminate_c2_Organizado5PosicionConEnviarDerivadasslx(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_Organizado5PosicionConEnviarDerivadasslx_optimization_info();
    }

    finalize_c2_Organizado5PosicionConEnviarDerivadasslx
      ((SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc2_Organizado5PosicionConEnviarDerivadasslx
    ((SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_Organizado5PosicionConEnviarDerivadasslx
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_Organizado5PosicionConEnviarDerivadasslx
  (SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
      load_Organizado5PosicionConEnviarDerivadasslx_optimization_info();
  ...
  ssSetChecksum0(S,(3963466869U));
  ssSetChecksum1(S,(4284878376U));
  ssSetChecksum2(S,(1517969353U));
  ssSetChecksum3(S,(884123448U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_Organizado5PosicionConEnviarDerivadasslx(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_Organizado5PosicionConEnviarDerivadasslx(SimStruct *S)
{
  SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct *)
    utMalloc(sizeof(SFc2_Organizado5PosicionConEnviarDerivadasslxInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_Organizado5PosicionConEnviarDerivadasslx;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_Organizado5PosicionConEnviarDerivadasslx;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_Organizado5PosicionConEnviarDerivadasslx;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_Organizado5PosicionConEnviarDerivadasslx;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_Organizado5PosicionConEnviarDerivadasslx;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_Organizado5PosicionConEnviarDerivadasslx;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_Organizado5PosicionConEnviarDerivadasslx;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_Organizado5PosicionConEnviarDerivadasslx;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c2_Organizado5PosicionConEnviarDerivadasslx;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c2_Organizado5PosicionConEnviarDerivadasslx;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_Organizado5PosicionConEnviarDerivadasslx;
...
void c2_Organizado5PosicionConEnviarDerivadasslx_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_Organizado5PosicionConEnviarDerivadasslx(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_Organizado5PosicionConEnviarDerivadasslx(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_Organizado5PosicionConEnviarDerivadasslx(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_Organizado5PosicionConEnviarDerivadasslx_method_dispatcher.\n"
