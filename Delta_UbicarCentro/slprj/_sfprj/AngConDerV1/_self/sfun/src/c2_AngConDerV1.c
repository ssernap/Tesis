...
static void initialize_c2_AngConDerV1(SFc2_AngConDerV1InstanceStruct
  *chartInstance);
static void initialize_params_c2_AngConDerV1(SFc2_AngConDerV1InstanceStruct
  *chartInstance);
static void enable_c2_AngConDerV1(SFc2_AngConDerV1InstanceStruct *chartInstance);
static void disable_c2_AngConDerV1(SFc2_AngConDerV1InstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_AngConDerV1
  (SFc2_AngConDerV1InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_AngConDerV1
  (SFc2_AngConDerV1InstanceStruct *chartInstance);
static void set_sim_state_c2_AngConDerV1(SFc2_AngConDerV1InstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_AngConDerV1(SFc2_AngConDerV1InstanceStruct
  *chartInstance);
static void sf_gateway_c2_AngConDerV1(SFc2_AngConDerV1InstanceStruct
  *chartInstance);
static void initSimStructsc2_AngConDerV1(SFc2_AngConDerV1InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_AngConDerV1InstanceStruct *chartInstance,
  const mxArray *c2_PosZ, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_AngConDerV1InstanceStruct
...
static real_T c2_mpower(SFc2_AngConDerV1InstanceStruct *chartInstance, real_T
  c2_a);
static void c2_eml_scalar_eg(SFc2_AngConDerV1InstanceStruct *chartInstance);
static real_T c2_b_mpower(SFc2_AngConDerV1InstanceStruct *chartInstance, real_T
  c2_a);
static real_T c2_c_mpower(SFc2_AngConDerV1InstanceStruct *chartInstance, real_T
  c2_a);
static real_T c2_d_mpower(SFc2_AngConDerV1InstanceStruct *chartInstance, real_T
  c2_a);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_c_emlrt_marshallIn(SFc2_AngConDerV1InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_d_emlrt_marshallIn(SFc2_AngConDerV1InstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_AngConDerV1, const char_T
  *c2_identifier);
static uint8_T c2_e_emlrt_marshallIn(SFc2_AngConDerV1InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_AngConDerV1InstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_AngConDerV1 = 0U;
}
  ...
  (SFc2_AngConDerV1InstanceStruct *chartInstance)
{
  ...
  c2_d_hoistedGlobal = chartInstance->c2_is_active_c2_AngConDerV1;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  *c2_PosZ = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u,
    2)), "PosZ");
  chartInstance->c2_is_active_c2_AngConDerV1 = c2_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 3)),
     "is_active_c2_AngConDerV1");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_AngConDerV1(chartInstance);
  ...
  if (CV_EML_IF(0, 1, 0, c2_time < c2_tf1 + c2_TIni)) {
    ...
    if (CV_EML_IF(0, 1, 1, c2_time < (c2_tf2 + c2_tf1) + c2_TIni)) {
      ...
      c2_PosY = ((((c2_a10x + 0.0 * c2_tiempo) + 0.0 * c2_d_mpower(chartInstance,
        c2_tiempo)) + 15.625 * c2_mpower(chartInstance, c2_tiempo)) + -5.859375 *
                 c2_b_mpower(chartInstance, c2_tiempo)) + 0.5859375 *
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_AngConDerV1InstanceStruct *chartInstance;
  chartInstance = (SFc2_AngConDerV1InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_AngConDerV1_get_eml_resolved_functions_info(void)
{
  ...
  *c2_identifier)
{
  ...
  c2_y = c2_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_AngConDerV1), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_AngConDerV1);
  return c2_y;
}
...
void sf_c2_AngConDerV1_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1316363257U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1507985375U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1154307441U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3754266004U);
}

mxArray *sf_c2_AngConDerV1_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("odakiMtG0O8JcNIPgm8FAD");
...
mxArray *sf_c2_AngConDerV1_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_AngConDerV1_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_AngConDerV1(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"PosX\",},{M[1],M[6],T\"PosY\",},{M[1],M[7],T\"PosZ\",},{M[8],M[0],T\"is_active_c2_AngConDerV1\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_AngConDerV1_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_AngConDerV1InstanceStruct *) chartInfo->chartInstance;
...
{
  return "qYCnjceBErT5MYHbiLJC2";
}

static void sf_opaque_initialize_c2_AngConDerV1(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_AngConDerV1InstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c2_AngConDerV1((SFc2_AngConDerV1InstanceStruct*)
    chartInstanceVar);
  initialize_c2_AngConDerV1((SFc2_AngConDerV1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_AngConDerV1(void *chartInstanceVar)
{
  enable_c2_AngConDerV1((SFc2_AngConDerV1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_AngConDerV1(void *chartInstanceVar)
{
  disable_c2_AngConDerV1((SFc2_AngConDerV1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_AngConDerV1(void *chartInstanceVar)
{
  sf_gateway_c2_AngConDerV1((SFc2_AngConDerV1InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_AngConDerV1(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_AngConDerV1
    ((SFc2_AngConDerV1InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_AngConDerV1();/* state var info */
...
extern void sf_internal_set_sim_state_c2_AngConDerV1(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_AngConDerV1();/* state var info */
  ...
  set_sim_state_c2_AngConDerV1((SFc2_AngConDerV1InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_AngConDerV1(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_AngConDerV1(S);
}

static void sf_opaque_set_sim_state_c2_AngConDerV1(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c2_AngConDerV1(S, st);
}

static void sf_opaque_terminate_c2_AngConDerV1(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_AngConDerV1InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_AngConDerV1((SFc2_AngConDerV1InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_AngConDerV1((SFc2_AngConDerV1InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_AngConDerV1(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_AngConDerV1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3126883670U));
  ssSetChecksum1(S,(4008698314U));
  ssSetChecksum2(S,(1784447013U));
  ssSetChecksum3(S,(1370189721U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_AngConDerV1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_AngConDerV1(SimStruct *S)
{
  SFc2_AngConDerV1InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_AngConDerV1InstanceStruct *)utMalloc(sizeof
    (SFc2_AngConDerV1InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_AngConDerV1InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_AngConDerV1;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_AngConDerV1;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_AngConDerV1;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_AngConDerV1;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_AngConDerV1;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_AngConDerV1;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_AngConDerV1;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_AngConDerV1;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_AngConDerV1;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_AngConDerV1;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_AngConDerV1;
...
void c2_AngConDerV1_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_AngConDerV1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_AngConDerV1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_AngConDerV1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_AngConDerV1_method_dispatcher.\n"
