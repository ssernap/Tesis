...
static void initialize_c5_simulacionfinal(SFc5_simulacionfinalInstanceStruct
  *chartInstance);
static void initialize_params_c5_simulacionfinal
  (SFc5_simulacionfinalInstanceStruct *chartInstance);
static void enable_c5_simulacionfinal(SFc5_simulacionfinalInstanceStruct
  *chartInstance);
static void disable_c5_simulacionfinal(SFc5_simulacionfinalInstanceStruct
  *chartInstance);
static void c5_update_debugger_state_c5_simulacionfinal
  (SFc5_simulacionfinalInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_simulacionfinal
  (SFc5_simulacionfinalInstanceStruct *chartInstance);
static void set_sim_state_c5_simulacionfinal(SFc5_simulacionfinalInstanceStruct *
  chartInstance, const mxArray *c5_st);
static void finalize_c5_simulacionfinal(SFc5_simulacionfinalInstanceStruct
  *chartInstance);
static void sf_gateway_c5_simulacionfinal(SFc5_simulacionfinalInstanceStruct
  *chartInstance);
static void initSimStructsc5_simulacionfinal(SFc5_simulacionfinalInstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber, uint32_T c5_instanceNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static real_T c5_emlrt_marshallIn(SFc5_simulacionfinalInstanceStruct
  *chartInstance, const mxArray *c5_q3, const char_T *c5_identifier);
static real_T c5_b_emlrt_marshallIn(SFc5_simulacionfinalInstanceStruct
...
static real_T c5_mpower(SFc5_simulacionfinalInstanceStruct *chartInstance,
  real_T c5_a);
static void c5_eml_scalar_eg(SFc5_simulacionfinalInstanceStruct *chartInstance);
static void c5_eml_error(SFc5_simulacionfinalInstanceStruct *chartInstance);
static void c5_b_eml_error(SFc5_simulacionfinalInstanceStruct *chartInstance);
static void c5_c_eml_error(SFc5_simulacionfinalInstanceStruct *chartInstance);
static const mxArray *c5_b_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_c_emlrt_marshallIn(SFc5_simulacionfinalInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static uint8_T c5_d_emlrt_marshallIn(SFc5_simulacionfinalInstanceStruct
  *chartInstance, const mxArray *c5_b_is_active_c5_simulacionfinal, const char_T
  *c5_identifier);
static uint8_T c5_e_emlrt_marshallIn(SFc5_simulacionfinalInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void init_dsm_address_info(SFc5_simulacionfinalInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_simulacionfinal = 0U;
}
  ...
  (SFc5_simulacionfinalInstanceStruct *chartInstance)
{
  ...
  c5_d_hoistedGlobal = chartInstance->c5_is_active_c5_simulacionfinal;
  ...
  chartInstance, const mxArray *c5_st)
{
  ...
  *c5_q3 = c5_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 2)),
    "q3");
  chartInstance->c5_is_active_c5_simulacionfinal = c5_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 3)),
     "is_active_c5_simulacionfinal");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_simulacionfinal(chartInstance);
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  const mxArray *c5_y = NULL;
  SFc5_simulacionfinalInstanceStruct *chartInstance;
  chartInstance = (SFc5_simulacionfinalInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c5_simulacionfinal_get_eml_resolved_functions_info(void)
{
  ...
  *c5_identifier)
{
  ...
  c5_y = c5_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_simulacionfinal), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_simulacionfinal);
  return c5_y;
}
...
void sf_c5_simulacionfinal_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4034265238U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1106228284U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2068434013U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(589799074U);
}

mxArray *sf_c5_simulacionfinal_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("hp9L1IIEUkVg3cRlvcBB4C");
...
mxArray *sf_c5_simulacionfinal_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c5_simulacionfinal_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c5_simulacionfinal(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[15],T\"q1\",},{M[1],M[16],T\"q2\",},{M[1],M[17],T\"q3\",},{M[8],M[0],T\"is_active_c5_simulacionfinal\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_simulacionfinal_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc5_simulacionfinalInstanceStruct *)
...
{
  return "M5lESeCdGr08egqTfBAYNE";
}

static void sf_opaque_initialize_c5_simulacionfinal(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_simulacionfinalInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c5_simulacionfinal((SFc5_simulacionfinalInstanceStruct*)
    chartInstanceVar);
  initialize_c5_simulacionfinal((SFc5_simulacionfinalInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c5_simulacionfinal(void *chartInstanceVar)
{
  enable_c5_simulacionfinal((SFc5_simulacionfinalInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c5_simulacionfinal(void *chartInstanceVar)
{
  disable_c5_simulacionfinal((SFc5_simulacionfinalInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c5_simulacionfinal(void *chartInstanceVar)
{
  sf_gateway_c5_simulacionfinal((SFc5_simulacionfinalInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c5_simulacionfinal(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_simulacionfinal
    ((SFc5_simulacionfinalInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_simulacionfinal();/* state var info */
...
extern void sf_internal_set_sim_state_c5_simulacionfinal(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c5_simulacionfinal();/* state var info */
  ...
  set_sim_state_c5_simulacionfinal((SFc5_simulacionfinalInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c5_simulacionfinal(SimStruct* S)
{
  return sf_internal_get_sim_state_c5_simulacionfinal(S);
}

static void sf_opaque_set_sim_state_c5_simulacionfinal(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c5_simulacionfinal(S, st);
}

static void sf_opaque_terminate_c5_simulacionfinal(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_simulacionfinalInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c5_simulacionfinal((SFc5_simulacionfinalInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc5_simulacionfinal((SFc5_simulacionfinalInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_simulacionfinal(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_simulacionfinal(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(2670868292U));
  ssSetChecksum1(S,(2796147107U));
  ssSetChecksum2(S,(536094503U));
  ssSetChecksum3(S,(2057200288U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c5_simulacionfinal(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_simulacionfinal(SimStruct *S)
{
  SFc5_simulacionfinalInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc5_simulacionfinalInstanceStruct *)utMalloc(sizeof
    (SFc5_simulacionfinalInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_simulacionfinalInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_simulacionfinal;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_simulacionfinal;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_simulacionfinal;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c5_simulacionfinal;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c5_simulacionfinal;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_simulacionfinal;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_simulacionfinal;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_simulacionfinal;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_simulacionfinal;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_simulacionfinal;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_simulacionfinal;
...
void c5_simulacionfinal_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_simulacionfinal(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_simulacionfinal(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_simulacionfinal(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_simulacionfinal_method_dispatcher.\n"
