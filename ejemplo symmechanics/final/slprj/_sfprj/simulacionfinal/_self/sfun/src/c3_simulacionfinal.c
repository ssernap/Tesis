...
static void initialize_c3_simulacionfinal(SFc3_simulacionfinalInstanceStruct
  *chartInstance);
static void initialize_params_c3_simulacionfinal
  (SFc3_simulacionfinalInstanceStruct *chartInstance);
static void enable_c3_simulacionfinal(SFc3_simulacionfinalInstanceStruct
  *chartInstance);
static void disable_c3_simulacionfinal(SFc3_simulacionfinalInstanceStruct
  *chartInstance);
static void c3_update_debugger_state_c3_simulacionfinal
  (SFc3_simulacionfinalInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_simulacionfinal
  (SFc3_simulacionfinalInstanceStruct *chartInstance);
static void set_sim_state_c3_simulacionfinal(SFc3_simulacionfinalInstanceStruct *
  chartInstance, const mxArray *c3_st);
static void finalize_c3_simulacionfinal(SFc3_simulacionfinalInstanceStruct
  *chartInstance);
static void sf_gateway_c3_simulacionfinal(SFc3_simulacionfinalInstanceStruct
  *chartInstance);
static void initSimStructsc3_simulacionfinal(SFc3_simulacionfinalInstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_simulacionfinalInstanceStruct
  *chartInstance, const mxArray *c3_q3, const char_T *c3_identifier);
static real_T c3_b_emlrt_marshallIn(SFc3_simulacionfinalInstanceStruct
...
static real_T c3_mpower(SFc3_simulacionfinalInstanceStruct *chartInstance,
  real_T c3_a);
static void c3_eml_scalar_eg(SFc3_simulacionfinalInstanceStruct *chartInstance);
static void c3_eml_error(SFc3_simulacionfinalInstanceStruct *chartInstance);
static void c3_b_eml_error(SFc3_simulacionfinalInstanceStruct *chartInstance);
static void c3_c_eml_error(SFc3_simulacionfinalInstanceStruct *chartInstance);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_c_emlrt_marshallIn(SFc3_simulacionfinalInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_d_emlrt_marshallIn(SFc3_simulacionfinalInstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_simulacionfinal, const char_T
  *c3_identifier);
static uint8_T c3_e_emlrt_marshallIn(SFc3_simulacionfinalInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_simulacionfinalInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_simulacionfinal = 0U;
}
  ...
  (SFc3_simulacionfinalInstanceStruct *chartInstance)
{
  ...
  c3_d_hoistedGlobal = chartInstance->c3_is_active_c3_simulacionfinal;
  ...
  chartInstance, const mxArray *c3_st)
{
  ...
  *c3_q3 = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 2)),
    "q3");
  chartInstance->c3_is_active_c3_simulacionfinal = c3_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 3)),
     "is_active_c3_simulacionfinal");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_simulacionfinal(chartInstance);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_simulacionfinalInstanceStruct *chartInstance;
  chartInstance = (SFc3_simulacionfinalInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_simulacionfinal_get_eml_resolved_functions_info(void)
{
  ...
  *c3_identifier)
{
  ...
  c3_y = c3_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_simulacionfinal), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_simulacionfinal);
  return c3_y;
}
...
void sf_c3_simulacionfinal_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4268579415U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2555237752U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2185672124U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(330314024U);
}

mxArray *sf_c3_simulacionfinal_get_autoinheritance_info(void)
{
...
mxArray *sf_c3_simulacionfinal_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_simulacionfinal_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c3_simulacionfinal(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[15],T\"q1\",},{M[1],M[16],T\"q2\",},{M[1],M[17],T\"q3\",},{M[8],M[0],T\"is_active_c3_simulacionfinal\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_simulacionfinal_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_simulacionfinalInstanceStruct *)
...
{
  return "ZStOoalWJjYnrKdUesN5gE";
}

static void sf_opaque_initialize_c3_simulacionfinal(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_simulacionfinalInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_simulacionfinal((SFc3_simulacionfinalInstanceStruct*)
    chartInstanceVar);
  initialize_c3_simulacionfinal((SFc3_simulacionfinalInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c3_simulacionfinal(void *chartInstanceVar)
{
  enable_c3_simulacionfinal((SFc3_simulacionfinalInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c3_simulacionfinal(void *chartInstanceVar)
{
  disable_c3_simulacionfinal((SFc3_simulacionfinalInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c3_simulacionfinal(void *chartInstanceVar)
{
  sf_gateway_c3_simulacionfinal((SFc3_simulacionfinalInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_simulacionfinal(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_simulacionfinal
    ((SFc3_simulacionfinalInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_simulacionfinal();/* state var info */
...
extern void sf_internal_set_sim_state_c3_simulacionfinal(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c3_simulacionfinal();/* state var info */
  ...
  set_sim_state_c3_simulacionfinal((SFc3_simulacionfinalInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_simulacionfinal(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_simulacionfinal(S);
}

static void sf_opaque_set_sim_state_c3_simulacionfinal(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c3_simulacionfinal(S, st);
}

static void sf_opaque_terminate_c3_simulacionfinal(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_simulacionfinalInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c3_simulacionfinal((SFc3_simulacionfinalInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc3_simulacionfinal((SFc3_simulacionfinalInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_simulacionfinal(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_simulacionfinal(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(1062876417U));
  ssSetChecksum1(S,(3939806126U));
  ssSetChecksum2(S,(15122217U));
  ssSetChecksum3(S,(3545950246U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c3_simulacionfinal(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_simulacionfinal(SimStruct *S)
{
  SFc3_simulacionfinalInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_simulacionfinalInstanceStruct *)utMalloc(sizeof
    (SFc3_simulacionfinalInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_simulacionfinalInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_simulacionfinal;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_simulacionfinal;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_simulacionfinal;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_simulacionfinal;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_simulacionfinal;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_simulacionfinal;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_simulacionfinal;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_simulacionfinal;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_simulacionfinal;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_simulacionfinal;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_simulacionfinal;
...
void c3_simulacionfinal_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_simulacionfinal(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_simulacionfinal(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_simulacionfinal(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_simulacionfinal_method_dispatcher.\n"
