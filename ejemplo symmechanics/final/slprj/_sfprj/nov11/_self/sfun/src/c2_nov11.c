...
static void initialize_c2_nov11(SFc2_nov11InstanceStruct *chartInstance);
static void initialize_params_c2_nov11(SFc2_nov11InstanceStruct *chartInstance);
static void enable_c2_nov11(SFc2_nov11InstanceStruct *chartInstance);
static void disable_c2_nov11(SFc2_nov11InstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_nov11(SFc2_nov11InstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c2_nov11(SFc2_nov11InstanceStruct
  *chartInstance);
static void set_sim_state_c2_nov11(SFc2_nov11InstanceStruct *chartInstance,
  const mxArray *c2_st);
static void finalize_c2_nov11(SFc2_nov11InstanceStruct *chartInstance);
static void sf_gateway_c2_nov11(SFc2_nov11InstanceStruct *chartInstance);
static void c2_chartstep_c2_nov11(SFc2_nov11InstanceStruct *chartInstance);
static void initSimStructsc2_nov11(SFc2_nov11InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_nov11InstanceStruct *chartInstance, const
  mxArray *c2_wz, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_nov11InstanceStruct *chartInstance,
...
static real_T c2_mpower(SFc2_nov11InstanceStruct *chartInstance, real_T c2_a);
static void c2_eml_scalar_eg(SFc2_nov11InstanceStruct *chartInstance);
static real_T c2_b_mpower(SFc2_nov11InstanceStruct *chartInstance, real_T c2_a);
static real_T c2_c_mpower(SFc2_nov11InstanceStruct *chartInstance, real_T c2_a);
static real_T c2_d_mpower(SFc2_nov11InstanceStruct *chartInstance, real_T c2_a);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_c_emlrt_marshallIn(SFc2_nov11InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_d_emlrt_marshallIn(SFc2_nov11InstanceStruct *chartInstance,
  const mxArray *c2_b_is_active_c2_nov11, const char_T *c2_identifier);
static uint8_T c2_e_emlrt_marshallIn(SFc2_nov11InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_nov11InstanceStruct *chartInstance);
...
static void initialize_c2_nov11(SFc2_nov11InstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_nov11 = 0U;
}
  ...
  *chartInstance)
{
  ...
  c2_d_hoistedGlobal = chartInstance->c2_is_active_c2_nov11;
  ...
  const mxArray *c2_st)
{
  ...
  *c2_y = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 2)),
    "y");
  chartInstance->c2_is_active_c2_nov11 = c2_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c2_u, 3)), "is_active_c2_nov11");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_nov11(chartInstance);
...
static void sf_gateway_c2_nov11(SFc2_nov11InstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_nov11(chartInstance);
...
static void c2_chartstep_c2_nov11(SFc2_nov11InstanceStruct *chartInstance)
{
  ...
  c2_db_y = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  ...
  c2_db_x = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  c2_d_x = c2_c_x;
  c2_d_y = c2_c_y;
  c2_a3x = c2_d_x / c2_d_y;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 7);
  c2_b_A = -(15.0 * (c2_pxf - c2_pxi));
  ...
  c2_g_x = c2_f_x;
  c2_g_y = c2_f_y;
  c2_a4x = c2_g_x / c2_g_y;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 8);
  c2_c_A = 6.0 * (c2_pxf - c2_pxi);
  ...
  c2_j_x = c2_i_x;
  c2_j_y = c2_i_y;
  c2_a5x = c2_j_x / c2_j_y;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 9);
  c2_x = ((((c2_a0x + 0.0 * c2_t) + 0.0 * c2_d_mpower(chartInstance, c2_t)) +
           c2_a3x * c2_mpower(chartInstance, c2_t)) + c2_a4x * c2_b_mpower
          (chartInstance, c2_t)) + c2_a5x * c2_c_mpower(chartInstance, c2_t);
  ...
  c2_m_x = c2_l_x;
  c2_m_y = c2_l_y;
  c2_a3y = c2_m_x / c2_m_y;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 14);
  c2_e_A = -(15.0 * (c2_pyf - c2_pyi));
  ...
  c2_p_x = c2_o_x;
  c2_p_y = c2_o_y;
  c2_a4y = c2_p_x / c2_p_y;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 15);
  c2_f_A = 6.0 * (c2_pyf - c2_pyi);
  ...
  c2_s_x = c2_r_x;
  c2_s_y = c2_r_y;
  c2_a5y = c2_s_x / c2_s_y;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 16);
  c2_y = ((((c2_a0y + 0.0 * c2_t) + 0.0 * c2_d_mpower(chartInstance, c2_t)) +
           c2_a3y * c2_mpower(chartInstance, c2_t)) + c2_a4y * c2_b_mpower
          (chartInstance, c2_t)) + c2_a5y * c2_c_mpower(chartInstance, c2_t);
  ...
  c2_v_x = c2_u_x;
  c2_v_y = c2_u_y;
  c2_a3wz = c2_v_x / c2_v_y;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 21);
  c2_h_A = -(15.0 * (c2_wzf - c2_wzi));
  ...
  c2_y_x = c2_x_x;
  c2_y_y = c2_x_y;
  c2_a4wz = c2_y_x / c2_y_y;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 22);
  c2_i_A = 6.0 * (c2_wzf - c2_wzi);
  ...
  c2_cb_x = c2_bb_x;
  c2_cb_y = c2_bb_y;
  c2_a5wz = c2_cb_x / c2_cb_y;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 23);
  c2_wz = ((((c2_a0wz + 0.0 * c2_t) + 0.0 * c2_d_mpower(chartInstance, c2_t)) +
            c2_a3wz * c2_mpower(chartInstance, c2_t)) + c2_a4wz * c2_b_mpower
           (chartInstance, c2_t)) + c2_a5wz * c2_c_mpower(chartInstance, c2_t);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, -23);
  _SFD_SYMBOL_SCOPE_POP();
  *c2_db_x = c2_x;
  *c2_db_y = c2_y;
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  real_T c2_u;
  const mxArray *c2_y = NULL;
  SFc2_nov11InstanceStruct *chartInstance;
  chartInstance = (SFc2_nov11InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_nov11_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c2_b_is_active_c2_nov11, const char_T *c2_identifier)
{
  ...
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_y = c2_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_b_is_active_c2_nov11),
    &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_nov11);
  return c2_y;
}
...
void sf_c2_nov11_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_nov11_get_autoinheritance_info(void)
{
...
mxArray *sf_c2_nov11_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_nov11_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_nov11(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[13],T\"wz\",},{M[1],M[5],T\"x\",},{M[1],M[12],T\"y\",},{M[8],M[0],T\"is_active_c2_nov11\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_nov11_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_nov11InstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c2_nov11(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_nov11InstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c2_nov11((SFc2_nov11InstanceStruct*) chartInstanceVar);
  initialize_c2_nov11((SFc2_nov11InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_nov11(void *chartInstanceVar)
{
  enable_c2_nov11((SFc2_nov11InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_nov11(void *chartInstanceVar)
{
  disable_c2_nov11((SFc2_nov11InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_nov11(void *chartInstanceVar)
{
  sf_gateway_c2_nov11((SFc2_nov11InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_nov11(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_nov11((SFc2_nov11InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_nov11();/* state var info */
...
extern void sf_internal_set_sim_state_c2_nov11(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_nov11();/* state var info */
  ...
  set_sim_state_c2_nov11((SFc2_nov11InstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_nov11(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_nov11(S);
}

static void sf_opaque_set_sim_state_c2_nov11(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_nov11(S, st);
}

static void sf_opaque_terminate_c2_nov11(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_nov11InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_nov11((SFc2_nov11InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_nov11((SFc2_nov11InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_nov11(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c2_nov11((SFc2_nov11InstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_nov11(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c2_nov11(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_nov11(SimStruct *S)
{
  SFc2_nov11InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_nov11InstanceStruct *)utMalloc(sizeof
    (SFc2_nov11InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_nov11InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_nov11;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_nov11;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_nov11;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_nov11;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_nov11;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_nov11;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_nov11;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c2_nov11;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_nov11;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_nov11;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_nov11;
...
void c2_nov11_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_nov11(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_nov11(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_nov11_method_dispatcher.\n"
