...
static const char * c3_debug_family_names[14] = { "l3", "l1", "l2", "xw", "yw",
  "nargin", "nargout", "x", "y", "wz", "tf", "q1", "q2", "q3" };

/* Function Declarations */
static void initialize_c3_nov11(SFc3_nov11InstanceStruct *chartInstance);
static void initialize_params_c3_nov11(SFc3_nov11InstanceStruct *chartInstance);
static void enable_c3_nov11(SFc3_nov11InstanceStruct *chartInstance);
static void disable_c3_nov11(SFc3_nov11InstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_nov11(SFc3_nov11InstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c3_nov11(SFc3_nov11InstanceStruct
  *chartInstance);
static void set_sim_state_c3_nov11(SFc3_nov11InstanceStruct *chartInstance,
  const mxArray *c3_st);
static void finalize_c3_nov11(SFc3_nov11InstanceStruct *chartInstance);
static void sf_gateway_c3_nov11(SFc3_nov11InstanceStruct *chartInstance);
static void initSimStructsc3_nov11(SFc3_nov11InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_nov11InstanceStruct *chartInstance, const
  mxArray *c3_q3, const char_T *c3_identifier);
static real_T c3_b_emlrt_marshallIn(SFc3_nov11InstanceStruct *chartInstance,
...
static real_T c3_mpower(SFc3_nov11InstanceStruct *chartInstance, real_T c3_a);
static void c3_eml_scalar_eg(SFc3_nov11InstanceStruct *chartInstance);
static void c3_eml_error(SFc3_nov11InstanceStruct *chartInstance);
static void c3_b_eml_error(SFc3_nov11InstanceStruct *chartInstance);
static void c3_c_eml_error(SFc3_nov11InstanceStruct *chartInstance);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_c_emlrt_marshallIn(SFc3_nov11InstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_d_emlrt_marshallIn(SFc3_nov11InstanceStruct *chartInstance,
  const mxArray *c3_b_is_active_c3_nov11, const char_T *c3_identifier);
static uint8_T c3_e_emlrt_marshallIn(SFc3_nov11InstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_nov11InstanceStruct *chartInstance);
...
static void initialize_c3_nov11(SFc3_nov11InstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_nov11 = 0U;
}
  ...
  *chartInstance)
{
  ...
  c3_d_hoistedGlobal = chartInstance->c3_is_active_c3_nov11;
  ...
  const mxArray *c3_st)
{
  ...
  *c3_q3 = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 2)),
    "q3");
  chartInstance->c3_is_active_c3_nov11 = c3_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c3_u, 3)), "is_active_c3_nov11");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_nov11(chartInstance);
...
static void sf_gateway_c3_nov11(SFc3_nov11InstanceStruct *chartInstance)
{
  ...
  c3_b_tf = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  ...
  c3_b_wz = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c3_k_y = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c3_y_x = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 2U, chartInstance->c3_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c3_y_x, 0U);
  _SFD_DATA_RANGE_CHECK(*c3_k_y, 1U);
  _SFD_DATA_RANGE_CHECK(*c3_b_wz, 2U);
  chartInstance->c3_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 2U, chartInstance->c3_sfEvent);
  c3_hoistedGlobal = *c3_y_x;
  c3_b_hoistedGlobal = *c3_k_y;
  c3_c_hoistedGlobal = *c3_b_wz;
  c3_d_hoistedGlobal = *c3_b_tf;
  c3_x = c3_hoistedGlobal;
  c3_y = c3_b_hoistedGlobal;
  c3_wz = c3_c_hoistedGlobal;
  c3_tf = c3_d_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 14U, 14U, c3_debug_family_names,
    c3_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_l3, 0U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_l1, 1U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_l2, 2U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_xw, 3U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_yw, 4U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_nargout, 6U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_x, 7U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_y, 8U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_wz, 9U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_tf, 10U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_q1, 11U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_q2, 12U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_q3, 13U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  if (CV_EML_IF(0, 1, 0, c3_tf < 10.0)) {
    ...
    if (CV_EML_IF(0, 1, 1, c3_tf > 20.0)) {
      ...
      c3_xw = c3_x - 10.0 * c3_c_x;
      _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 19);
      c3_d_x = c3_wz;
      c3_e_x = c3_d_x;
      c3_e_x = muDoubleScalarSin(c3_e_x);
      c3_yw = c3_y - 10.0 * c3_e_x;
      _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 21);
      c3_A = ((c3_mpower(chartInstance, c3_xw) + c3_mpower(chartInstance, c3_yw))
              - c3_mpower(chartInstance, 20.0)) - c3_mpower(chartInstance, 20.0);
      c3_f_x = c3_A;
      c3_g_x = c3_f_x;
      c3_h_x = c3_g_x;
      c3_b_y = c3_h_x / 800.0;
      ...
      c3_j_x = muDoubleScalarAcos(c3_j_x);
      c3_q2 = -c3_j_x;
      _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 22);
      c3_k_x = -c3_q2;
      c3_l_x = c3_k_x;
      c3_l_x = muDoubleScalarSin(c3_l_x);
      c3_m_x = c3_mpower(chartInstance, c3_xw) + c3_mpower(chartInstance, c3_yw);
      c3_n_x = c3_m_x;
      if (c3_n_x < 0.0) {
      ...
      c3_s_x = muDoubleScalarAsin(c3_s_x);
      c3_c_A = c3_yw;
      c3_b_B = c3_xw;
      c3_t_x = c3_c_A;
      c3_g_y = c3_b_B;
  ...
  *c3_b_q3 = c3_q3;
  ...
  _SFD_DATA_RANGE_CHECK(*c3_b_q1, 3U);
  _SFD_DATA_RANGE_CHECK(*c3_b_q2, 4U);
  _SFD_DATA_RANGE_CHECK(*c3_b_q3, 5U);
  _SFD_DATA_RANGE_CHECK(*c3_b_tf, 6U);
}
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  real_T c3_u;
  const mxArray *c3_y = NULL;
  SFc3_nov11InstanceStruct *chartInstance;
  chartInstance = (SFc3_nov11InstanceStruct *)chartInstanceVoid;
  ...
  mxArray *c3_q3, const char_T *c3_identifier)
{
  ...
  c3_y = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_q3), &c3_thisId);
  sf_mex_destroy(&c3_q3);
  return c3_y;
}
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  SFc3_nov11InstanceStruct *chartInstance;
  chartInstance = (SFc3_nov11InstanceStruct *)chartInstanceVoid;
  c3_q3 = sf_mex_dup(c3_mxArrayInData);
...
const mxArray *sf_c3_nov11_get_eml_resolved_functions_info(void)
{
  const mxArray *c3_nameCaptureInfo = NULL;
  c3_nameCaptureInfo = NULL;
  sf_mex_assign(&c3_nameCaptureInfo, sf_mex_createstruct("structure", 2, 35, 1),
                false);
...
static void c3_info_helper(const mxArray **c3_info)
{
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/cos.m"), "resolved",
                  "resolved", 0);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1343855572U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("mpower"), "name", "name", 4);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 4);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 6);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("ismatrix"), "name", "name", 6);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 6);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 7);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("power"), "name", "name", 7);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 7);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("mrdivide"), "name", "name", 17);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 17);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "context",
                  "context", 19);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("rdivide"), "name", "name", 19);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 19);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "context",
                  "context", 22);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("eml_div"), "name", "name", 22);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 22);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("acos"), "name", "name", 24);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 24);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/acos.m"), "resolved",
                  "resolved", 24);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1343855566U), "fileTimeLo",
                  "fileTimeLo", 24);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 24);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1343855576U), "fileTimeLo",
                  "fileTimeLo", 26);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 26);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("sqrt"), "name", "name", 27);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 27);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/asin.m"), "resolved",
                  "resolved", 30);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1343855570U), "fileTimeLo",
                  "fileTimeLo", 30);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 30);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("atan"), "name", "name", 33);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 33);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1286843918U), "fileTimeLo",
                  "fileTimeLo", 34);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 34);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
...
static void c3_c_eml_error(SFc3_nov11InstanceStruct *chartInstance)
{
  ...
  const mxArray *c3_y = NULL;
  int32_T c3_i5;
  static char_T c3_cv5[4] = { 'a', 's', 'i', 'n' };

  char_T c3_b_u[4];
  const mxArray *c3_b_y = NULL;
  (void)chartInstance;
  for (c3_i4 = 0; c3_i4 < 30; c3_i4++) {
    c3_u[c3_i4] = c3_cv4[c3_i4];
  }

  c3_y = NULL;
  sf_mex_assign(&c3_y, sf_mex_create("y", c3_u, 10, 0U, 1U, 0U, 2, 1, 30), false);
  for (c3_i5 = 0; c3_i5 < 4; c3_i5++) {
    c3_b_u[c3_i5] = c3_cv5[c3_i5];
  }
  ...
  const mxArray *c3_b_is_active_c3_nov11, const char_T *c3_identifier)
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_y = c3_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_b_is_active_c3_nov11),
    &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_nov11);
  return c3_y;
}
...
void sf_c3_nov11_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(336474976U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3885165213U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1606608036U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(480142028U);
}

mxArray *sf_c3_nov11_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("0iytrghZhg92Sv7MPj2QS");
...
mxArray *sf_c3_nov11_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_nov11_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c3_nov11(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[15],T\"q1\",},{M[1],M[16],T\"q2\",},{M[1],M[17],T\"q3\",},{M[8],M[0],T\"is_active_c3_nov11\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_nov11_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_nov11InstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T *c3_q3;
          real_T *c3_tf;
          c3_tf = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
          c3_q3 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 3);
          c3_q2 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
          c3_q1 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c3_wz = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
          ...
          _SFD_SET_DATA_VALUE_PTR(2U, c3_wz);
          _SFD_SET_DATA_VALUE_PTR(3U, c3_q1);
          _SFD_SET_DATA_VALUE_PTR(4U, c3_q2);
          _SFD_SET_DATA_VALUE_PTR(5U, c3_q3);
          _SFD_SET_DATA_VALUE_PTR(6U, c3_tf);
        }
      }
    } else {
...
{
  return "awRj7PlwTixmelzFQxNKPH";
}

static void sf_opaque_initialize_c3_nov11(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_nov11InstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c3_nov11((SFc3_nov11InstanceStruct*) chartInstanceVar);
  initialize_c3_nov11((SFc3_nov11InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_nov11(void *chartInstanceVar)
{
  enable_c3_nov11((SFc3_nov11InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_nov11(void *chartInstanceVar)
{
  disable_c3_nov11((SFc3_nov11InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_nov11(void *chartInstanceVar)
{
  sf_gateway_c3_nov11((SFc3_nov11InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_nov11(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_nov11((SFc3_nov11InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_nov11();/* state var info */
...
extern void sf_internal_set_sim_state_c3_nov11(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c3_nov11();/* state var info */
  ...
  set_sim_state_c3_nov11((SFc3_nov11InstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_nov11(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_nov11(S);
}

static void sf_opaque_set_sim_state_c3_nov11(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c3_nov11(S, st);
}

static void sf_opaque_terminate_c3_nov11(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_nov11InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c3_nov11((SFc3_nov11InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_nov11((SFc3_nov11InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_nov11(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c3_nov11((SFc3_nov11InstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c3_nov11(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(1521818691U));
  ssSetChecksum1(S,(2896970263U));
  ssSetChecksum2(S,(2704969333U));
  ssSetChecksum3(S,(3811963685U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c3_nov11(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_nov11(SimStruct *S)
{
  SFc3_nov11InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_nov11InstanceStruct *)utMalloc(sizeof
    (SFc3_nov11InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_nov11InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c3_nov11;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c3_nov11;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c3_nov11;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_nov11;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_nov11;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c3_nov11;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c3_nov11;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c3_nov11;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_nov11;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_nov11;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_nov11;
...
void c3_nov11_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_nov11(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_nov11(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_nov11_method_dispatcher.\n"
