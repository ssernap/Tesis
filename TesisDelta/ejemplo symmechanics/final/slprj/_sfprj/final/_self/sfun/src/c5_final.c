...
static void initialize_c5_final(SFc5_finalInstanceStruct *chartInstance);
static void initialize_params_c5_final(SFc5_finalInstanceStruct *chartInstance);
static void enable_c5_final(SFc5_finalInstanceStruct *chartInstance);
static void disable_c5_final(SFc5_finalInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_final(SFc5_finalInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c5_final(SFc5_finalInstanceStruct
  *chartInstance);
static void set_sim_state_c5_final(SFc5_finalInstanceStruct *chartInstance,
  const mxArray *c5_st);
static void finalize_c5_final(SFc5_finalInstanceStruct *chartInstance);
static void sf_gateway_c5_final(SFc5_finalInstanceStruct *chartInstance);
static void initSimStructsc5_final(SFc5_finalInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber, uint32_T c5_instanceNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static real_T c5_emlrt_marshallIn(SFc5_finalInstanceStruct *chartInstance, const
  mxArray *c5_q3, const char_T *c5_identifier);
static real_T c5_b_emlrt_marshallIn(SFc5_finalInstanceStruct *chartInstance,
...
static real_T c5_mpower(SFc5_finalInstanceStruct *chartInstance, real_T c5_a);
static void c5_eml_scalar_eg(SFc5_finalInstanceStruct *chartInstance);
static void c5_eml_error(SFc5_finalInstanceStruct *chartInstance);
static void c5_b_eml_error(SFc5_finalInstanceStruct *chartInstance);
static void c5_c_eml_error(SFc5_finalInstanceStruct *chartInstance);
static const mxArray *c5_b_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_c_emlrt_marshallIn(SFc5_finalInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static uint8_T c5_d_emlrt_marshallIn(SFc5_finalInstanceStruct *chartInstance,
  const mxArray *c5_b_is_active_c5_final, const char_T *c5_identifier);
static uint8_T c5_e_emlrt_marshallIn(SFc5_finalInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void init_dsm_address_info(SFc5_finalInstanceStruct *chartInstance);
...
static void initialize_c5_final(SFc5_finalInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_final = 0U;
}
  ...
  *chartInstance)
{
  ...
  c5_d_hoistedGlobal = chartInstance->c5_is_active_c5_final;
  ...
  const mxArray *c5_st)
{
  ...
  *c5_q3 = c5_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 2)),
    "q3");
  chartInstance->c5_is_active_c5_final = c5_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c5_u, 3)), "is_active_c5_final");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_final(chartInstance);
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  real_T c5_u;
  const mxArray *c5_y = NULL;
  SFc5_finalInstanceStruct *chartInstance;
  chartInstance = (SFc5_finalInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c5_final_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c5_b_is_active_c5_final, const char_T *c5_identifier)
{
  ...
  c5_thisId.fIdentifier = c5_identifier;
  c5_thisId.fParent = NULL;
  c5_y = c5_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_b_is_active_c5_final),
    &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_final);
  return c5_y;
}
...
void sf_c5_final_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3923983507U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4268257639U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3067461774U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(979002030U);
}

mxArray *sf_c5_final_get_autoinheritance_info(void)
{
...
mxArray *sf_c5_final_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c5_final_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c5_final(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[15],T\"q1\",},{M[1],M[16],T\"q2\",},{M[1],M[17],T\"q3\",},{M[8],M[0],T\"is_active_c5_final\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_final_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc5_finalInstanceStruct *) chartInfo->chartInstance;
...
{
  return "RhiYhEe6xFZ1bfZCisHbvD";
}

static void sf_opaque_initialize_c5_final(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_finalInstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c5_final((SFc5_finalInstanceStruct*) chartInstanceVar);
  initialize_c5_final((SFc5_finalInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_final(void *chartInstanceVar)
{
  enable_c5_final((SFc5_finalInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_final(void *chartInstanceVar)
{
  disable_c5_final((SFc5_finalInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_final(void *chartInstanceVar)
{
  sf_gateway_c5_final((SFc5_finalInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c5_final(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_final((SFc5_finalInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_final();/* state var info */
...
extern void sf_internal_set_sim_state_c5_final(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c5_final();/* state var info */
  ...
  set_sim_state_c5_final((SFc5_finalInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c5_final(SimStruct* S)
{
  return sf_internal_get_sim_state_c5_final(S);
}

static void sf_opaque_set_sim_state_c5_final(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c5_final(S, st);
}

static void sf_opaque_terminate_c5_final(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_finalInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c5_final((SFc5_finalInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_final((SFc5_finalInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_final(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c5_final((SFc5_finalInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c5_final(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(1873851815U));
  ssSetChecksum1(S,(2911612616U));
  ssSetChecksum2(S,(891288603U));
  ssSetChecksum3(S,(3077848270U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c5_final(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_final(SimStruct *S)
{
  SFc5_finalInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc5_finalInstanceStruct *)utMalloc(sizeof
    (SFc5_finalInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_finalInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c5_final;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c5_final;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c5_final;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c5_final;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c5_final;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c5_final;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c5_final;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c5_final;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_final;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_final;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c5_final;
...
void c5_final_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_final(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_final(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_final_method_dispatcher.\n"
