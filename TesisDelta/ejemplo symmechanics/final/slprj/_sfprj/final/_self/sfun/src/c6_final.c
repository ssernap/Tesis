...
static void initialize_c6_final(SFc6_finalInstanceStruct *chartInstance);
static void initialize_params_c6_final(SFc6_finalInstanceStruct *chartInstance);
static void enable_c6_final(SFc6_finalInstanceStruct *chartInstance);
static void disable_c6_final(SFc6_finalInstanceStruct *chartInstance);
static void c6_update_debugger_state_c6_final(SFc6_finalInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c6_final(SFc6_finalInstanceStruct
  *chartInstance);
static void set_sim_state_c6_final(SFc6_finalInstanceStruct *chartInstance,
  const mxArray *c6_st);
static void finalize_c6_final(SFc6_finalInstanceStruct *chartInstance);
static void sf_gateway_c6_final(SFc6_finalInstanceStruct *chartInstance);
static void c6_chartstep_c6_final(SFc6_finalInstanceStruct *chartInstance);
static void initSimStructsc6_final(SFc6_finalInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber, uint32_T c6_instanceNumber);
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData);
static real_T c6_emlrt_marshallIn(SFc6_finalInstanceStruct *chartInstance, const
  mxArray *c6_wz, const char_T *c6_identifier);
static real_T c6_b_emlrt_marshallIn(SFc6_finalInstanceStruct *chartInstance,
...
static real_T c6_mpower(SFc6_finalInstanceStruct *chartInstance, real_T c6_a);
static void c6_eml_scalar_eg(SFc6_finalInstanceStruct *chartInstance);
static real_T c6_b_mpower(SFc6_finalInstanceStruct *chartInstance, real_T c6_a);
static real_T c6_c_mpower(SFc6_finalInstanceStruct *chartInstance, real_T c6_a);
static real_T c6_d_mpower(SFc6_finalInstanceStruct *chartInstance, real_T c6_a);
static const mxArray *c6_b_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static int32_T c6_c_emlrt_marshallIn(SFc6_finalInstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static uint8_T c6_d_emlrt_marshallIn(SFc6_finalInstanceStruct *chartInstance,
  const mxArray *c6_b_is_active_c6_final, const char_T *c6_identifier);
static uint8_T c6_e_emlrt_marshallIn(SFc6_finalInstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void init_dsm_address_info(SFc6_finalInstanceStruct *chartInstance);
...
static void initialize_c6_final(SFc6_finalInstanceStruct *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_final = 0U;
}
  ...
  *chartInstance)
{
  ...
  c6_d_hoistedGlobal = chartInstance->c6_is_active_c6_final;
  ...
  const mxArray *c6_st)
{
  ...
  *c6_y = c6_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c6_u, 2)),
    "y");
  chartInstance->c6_is_active_c6_final = c6_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c6_u, 3)), "is_active_c6_final");
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_final(chartInstance);
...
static void sf_gateway_c6_final(SFc6_finalInstanceStruct *chartInstance)
{
  ...
  chartInstance->c6_sfEvent = CALL_EVENT;
  c6_chartstep_c6_final(chartInstance);
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  real_T c6_u;
  const mxArray *c6_y = NULL;
  SFc6_finalInstanceStruct *chartInstance;
  chartInstance = (SFc6_finalInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c6_final_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c6_b_is_active_c6_final, const char_T *c6_identifier)
{
  ...
  c6_thisId.fIdentifier = c6_identifier;
  c6_thisId.fParent = NULL;
  c6_y = c6_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c6_b_is_active_c6_final),
    &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_final);
  return c6_y;
}
...
void sf_c6_final_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c6_final_get_autoinheritance_info(void)
{
...
mxArray *sf_c6_final_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c6_final_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c6_final(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[13],T\"wz\",},{M[1],M[5],T\"x\",},{M[1],M[12],T\"y\",},{M[8],M[0],T\"is_active_c6_final\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_final_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc6_finalInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c6_final(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc6_finalInstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c6_final((SFc6_finalInstanceStruct*) chartInstanceVar);
  initialize_c6_final((SFc6_finalInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c6_final(void *chartInstanceVar)
{
  enable_c6_final((SFc6_finalInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c6_final(void *chartInstanceVar)
{
  disable_c6_final((SFc6_finalInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c6_final(void *chartInstanceVar)
{
  sf_gateway_c6_final((SFc6_finalInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c6_final(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c6_final((SFc6_finalInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c6_final();/* state var info */
...
extern void sf_internal_set_sim_state_c6_final(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c6_final();/* state var info */
  ...
  set_sim_state_c6_final((SFc6_finalInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c6_final(SimStruct* S)
{
  return sf_internal_get_sim_state_c6_final(S);
}

static void sf_opaque_set_sim_state_c6_final(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c6_final(S, st);
}

static void sf_opaque_terminate_c6_final(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_finalInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c6_final((SFc6_finalInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc6_final((SFc6_finalInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_final(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c6_final((SFc6_finalInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c6_final(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c6_final(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_final(SimStruct *S)
{
  SFc6_finalInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc6_finalInstanceStruct *)utMalloc(sizeof
    (SFc6_finalInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc6_finalInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c6_final;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c6_final;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c6_final;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c6_final;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c6_final;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c6_final;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c6_final;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c6_final;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_final;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_final;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c6_final;
...
void c6_final_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_final(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_final(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_final_method_dispatcher.\n"
