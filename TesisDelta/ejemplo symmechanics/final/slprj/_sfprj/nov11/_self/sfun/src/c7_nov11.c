...
static void initialize_c7_nov11(SFc7_nov11InstanceStruct *chartInstance);
static void initialize_params_c7_nov11(SFc7_nov11InstanceStruct *chartInstance);
static void enable_c7_nov11(SFc7_nov11InstanceStruct *chartInstance);
static void disable_c7_nov11(SFc7_nov11InstanceStruct *chartInstance);
static void c7_update_debugger_state_c7_nov11(SFc7_nov11InstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c7_nov11(SFc7_nov11InstanceStruct
  *chartInstance);
static void set_sim_state_c7_nov11(SFc7_nov11InstanceStruct *chartInstance,
  const mxArray *c7_st);
static void finalize_c7_nov11(SFc7_nov11InstanceStruct *chartInstance);
static void sf_gateway_c7_nov11(SFc7_nov11InstanceStruct *chartInstance);
static void initSimStructsc7_nov11(SFc7_nov11InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c7_machineNumber, uint32_T
  c7_chartNumber, uint32_T c7_instanceNumber);
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData);
static real_T c7_emlrt_marshallIn(SFc7_nov11InstanceStruct *chartInstance, const
  mxArray *c7_wz, const char_T *c7_identifier);
static real_T c7_b_emlrt_marshallIn(SFc7_nov11InstanceStruct *chartInstance,
...
static real_T c7_mpower(SFc7_nov11InstanceStruct *chartInstance, real_T c7_a);
static void c7_eml_scalar_eg(SFc7_nov11InstanceStruct *chartInstance);
static real_T c7_b_mpower(SFc7_nov11InstanceStruct *chartInstance, real_T c7_a);
static const mxArray *c7_b_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static int32_T c7_c_emlrt_marshallIn(SFc7_nov11InstanceStruct *chartInstance,
  const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static uint8_T c7_d_emlrt_marshallIn(SFc7_nov11InstanceStruct *chartInstance,
  const mxArray *c7_b_is_active_c7_nov11, const char_T *c7_identifier);
static uint8_T c7_e_emlrt_marshallIn(SFc7_nov11InstanceStruct *chartInstance,
  const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void init_dsm_address_info(SFc7_nov11InstanceStruct *chartInstance);
...
static void initialize_c7_nov11(SFc7_nov11InstanceStruct *chartInstance)
{
  ...
  chartInstance->c7_is_active_c7_nov11 = 0U;
}
  ...
  *chartInstance)
{
  ...
  c7_d_hoistedGlobal = chartInstance->c7_is_active_c7_nov11;
  ...
  const mxArray *c7_st)
{
  ...
  *c7_y = c7_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 2)),
    "y");
  chartInstance->c7_is_active_c7_nov11 = c7_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c7_u, 3)), "is_active_c7_nov11");
  sf_mex_destroy(&c7_u);
  c7_update_debugger_state_c7_nov11(chartInstance);
...
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData)
{
  ...
  real_T c7_u;
  const mxArray *c7_y = NULL;
  SFc7_nov11InstanceStruct *chartInstance;
  chartInstance = (SFc7_nov11InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c7_nov11_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c7_b_is_active_c7_nov11, const char_T *c7_identifier)
{
  ...
  c7_thisId.fIdentifier = c7_identifier;
  c7_thisId.fParent = NULL;
  c7_y = c7_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c7_b_is_active_c7_nov11),
    &c7_thisId);
  sf_mex_destroy(&c7_b_is_active_c7_nov11);
  return c7_y;
}
...
void sf_c7_nov11_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c7_nov11_get_autoinheritance_info(void)
{
...
mxArray *sf_c7_nov11_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c7_nov11_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c7_nov11(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[13],T\"wz\",},{M[1],M[5],T\"x\",},{M[1],M[12],T\"y\",},{M[8],M[0],T\"is_active_c7_nov11\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c7_nov11_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc7_nov11InstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c7_nov11(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc7_nov11InstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c7_nov11((SFc7_nov11InstanceStruct*) chartInstanceVar);
  initialize_c7_nov11((SFc7_nov11InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c7_nov11(void *chartInstanceVar)
{
  enable_c7_nov11((SFc7_nov11InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c7_nov11(void *chartInstanceVar)
{
  disable_c7_nov11((SFc7_nov11InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c7_nov11(void *chartInstanceVar)
{
  sf_gateway_c7_nov11((SFc7_nov11InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c7_nov11(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c7_nov11((SFc7_nov11InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c7_nov11();/* state var info */
...
extern void sf_internal_set_sim_state_c7_nov11(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c7_nov11();/* state var info */
  ...
  set_sim_state_c7_nov11((SFc7_nov11InstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c7_nov11(SimStruct* S)
{
  return sf_internal_get_sim_state_c7_nov11(S);
}

static void sf_opaque_set_sim_state_c7_nov11(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c7_nov11(S, st);
}

static void sf_opaque_terminate_c7_nov11(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc7_nov11InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c7_nov11((SFc7_nov11InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc7_nov11((SFc7_nov11InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c7_nov11(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c7_nov11((SFc7_nov11InstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c7_nov11(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c7_nov11(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c7_nov11(SimStruct *S)
{
  SFc7_nov11InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc7_nov11InstanceStruct *)utMalloc(sizeof
    (SFc7_nov11InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc7_nov11InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c7_nov11;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c7_nov11;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c7_nov11;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c7_nov11;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c7_nov11;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c7_nov11;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c7_nov11;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c7_nov11;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c7_nov11;
  chartInstance->chartInfo.mdlStart = mdlStart_c7_nov11;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c7_nov11;
...
void c7_nov11_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c7_nov11(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c7_nov11(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_nov11_method_dispatcher.\n"
