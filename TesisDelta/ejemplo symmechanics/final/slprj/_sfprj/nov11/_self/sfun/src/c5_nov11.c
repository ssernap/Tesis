...
#include <stddef.h>
#include "blas.h"
#include "nov11_sfun.h"
#include "c5_nov11.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "nov11_sfun_debug_macros.h"
...
static const char * c5_debug_family_names[14] = { "l3", "l1", "l2", "xw", "yw",
  "nargin", "nargout", "x", "y", "wz", "tf", "q1", "q2", "q3" };

/* Function Declarations */
static void initialize_c5_nov11(SFc5_nov11InstanceStruct *chartInstance);
static void initialize_params_c5_nov11(SFc5_nov11InstanceStruct *chartInstance);
static void enable_c5_nov11(SFc5_nov11InstanceStruct *chartInstance);
static void disable_c5_nov11(SFc5_nov11InstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_nov11(SFc5_nov11InstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c5_nov11(SFc5_nov11InstanceStruct
  *chartInstance);
static void set_sim_state_c5_nov11(SFc5_nov11InstanceStruct *chartInstance,
  const mxArray *c5_st);
static void finalize_c5_nov11(SFc5_nov11InstanceStruct *chartInstance);
static void sf_gateway_c5_nov11(SFc5_nov11InstanceStruct *chartInstance);
static void initSimStructsc5_nov11(SFc5_nov11InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber, uint32_T c5_instanceNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static real_T c5_emlrt_marshallIn(SFc5_nov11InstanceStruct *chartInstance, const
  mxArray *c5_q3, const char_T *c5_identifier);
static real_T c5_b_emlrt_marshallIn(SFc5_nov11InstanceStruct *chartInstance,
...
static real_T c5_mpower(SFc5_nov11InstanceStruct *chartInstance, real_T c5_a);
static void c5_eml_scalar_eg(SFc5_nov11InstanceStruct *chartInstance);
static void c5_eml_error(SFc5_nov11InstanceStruct *chartInstance);
static void c5_b_eml_error(SFc5_nov11InstanceStruct *chartInstance);
static void c5_c_eml_error(SFc5_nov11InstanceStruct *chartInstance);
static const mxArray *c5_b_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_c_emlrt_marshallIn(SFc5_nov11InstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static uint8_T c5_d_emlrt_marshallIn(SFc5_nov11InstanceStruct *chartInstance,
  const mxArray *c5_b_is_active_c5_nov11, const char_T *c5_identifier);
static uint8_T c5_e_emlrt_marshallIn(SFc5_nov11InstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void init_dsm_address_info(SFc5_nov11InstanceStruct *chartInstance);
...
static void initialize_c5_nov11(SFc5_nov11InstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_nov11 = 0U;
}
  ...
  *chartInstance)
{
  ...
  real_T *c5_q2;
  real_T *c5_q3;
  c5_q3 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 3);
  c5_q2 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c5_q1 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c5_st = NULL;
  c5_st = NULL;
  c5_y = NULL;
  sf_mex_assign(&c5_y, sf_mex_createcellmatrix(4, 1), false);
  c5_hoistedGlobal = *c5_q1;
  c5_u = c5_hoistedGlobal;
  c5_b_y = NULL;
  sf_mex_assign(&c5_b_y, sf_mex_create("y", &c5_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c5_y, 0, c5_b_y);
  c5_b_hoistedGlobal = *c5_q2;
  c5_b_u = c5_b_hoistedGlobal;
  c5_c_y = NULL;
  sf_mex_assign(&c5_c_y, sf_mex_create("y", &c5_b_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c5_y, 1, c5_c_y);
  c5_c_hoistedGlobal = *c5_q3;
  c5_c_u = c5_c_hoistedGlobal;
  c5_d_y = NULL;
  sf_mex_assign(&c5_d_y, sf_mex_create("y", &c5_c_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c5_y, 2, c5_d_y);
  c5_d_hoistedGlobal = chartInstance->c5_is_active_c5_nov11;
  ...
  const mxArray *c5_st)
{
  ...
  *c5_q1 = c5_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 0)),
    "q1");
  *c5_q2 = c5_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 1)),
    "q2");
  *c5_q3 = c5_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 2)),
    "q3");
  chartInstance->c5_is_active_c5_nov11 = c5_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c5_u, 3)), "is_active_c5_nov11");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_nov11(chartInstance);
...
static void sf_gateway_c5_nov11(SFc5_nov11InstanceStruct *chartInstance)
{
  ...
  c5_b_tf = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  c5_b_q3 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 3);
  c5_b_q2 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c5_b_q1 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c5_b_wz = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c5_k_y = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c5_y_x = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 4U, chartInstance->c5_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c5_y_x, 0U);
  _SFD_DATA_RANGE_CHECK(*c5_k_y, 1U);
  _SFD_DATA_RANGE_CHECK(*c5_b_wz, 2U);
  chartInstance->c5_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 4U, chartInstance->c5_sfEvent);
  c5_hoistedGlobal = *c5_y_x;
  c5_b_hoistedGlobal = *c5_k_y;
  c5_c_hoistedGlobal = *c5_b_wz;
  c5_d_hoistedGlobal = *c5_b_tf;
  c5_x = c5_hoistedGlobal;
  c5_y = c5_b_hoistedGlobal;
  c5_wz = c5_c_hoistedGlobal;
  c5_tf = c5_d_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 14U, 14U, c5_debug_family_names,
    c5_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_l3, 0U, c5_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_l1, 1U, c5_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_l2, 2U, c5_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_xw, 3U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_yw, 4U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_nargout, 6U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_x, 7U, c5_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_y, 8U, c5_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_wz, 9U, c5_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_tf, 10U, c5_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_q1, 11U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_q2, 12U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_q3, 13U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  if (CV_EML_IF(0, 1, 0, c5_tf < 20.0)) {
    ...
    if (CV_EML_IF(0, 1, 1, c5_tf > 30.0)) {
      ...
      c5_xw = c5_x - 10.0 * c5_c_x;
      _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 19);
      c5_d_x = c5_wz;
      c5_e_x = c5_d_x;
      c5_e_x = muDoubleScalarSin(c5_e_x);
      c5_yw = c5_y - 10.0 * c5_e_x;
      _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 21);
      c5_A = ((c5_mpower(chartInstance, c5_xw) + c5_mpower(chartInstance, c5_yw))
              - c5_mpower(chartInstance, 20.0)) - c5_mpower(chartInstance, 20.0);
      c5_f_x = c5_A;
      c5_g_x = c5_f_x;
      c5_h_x = c5_g_x;
      c5_b_y = c5_h_x / 800.0;
      ...
      c5_j_x = muDoubleScalarAcos(c5_j_x);
      c5_q2 = -c5_j_x;
      _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 22);
      c5_k_x = -c5_q2;
      c5_l_x = c5_k_x;
      c5_l_x = muDoubleScalarSin(c5_l_x);
      c5_m_x = c5_mpower(chartInstance, c5_xw) + c5_mpower(chartInstance, c5_yw);
      c5_n_x = c5_m_x;
      if (c5_n_x < 0.0) {
        c5_b_eml_error(chartInstance);
      }

      c5_n_x = muDoubleScalarSqrt(c5_n_x);
      c5_b_A = 20.0 * c5_l_x;
      c5_B = c5_n_x;
      c5_o_x = c5_b_A;
      c5_c_y = c5_B;
      ...
      c5_s_x = muDoubleScalarAsin(c5_s_x);
      c5_c_A = c5_yw;
      c5_b_B = c5_xw;
      c5_t_x = c5_c_A;
      c5_g_y = c5_b_B;
  ...
  *c5_b_q3 = c5_q3;
  ...
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_nov11MachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  _SFD_DATA_RANGE_CHECK(*c5_b_q1, 3U);
  _SFD_DATA_RANGE_CHECK(*c5_b_q2, 4U);
  _SFD_DATA_RANGE_CHECK(*c5_b_q3, 5U);
  _SFD_DATA_RANGE_CHECK(*c5_b_tf, 6U);
}
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  real_T c5_u;
  const mxArray *c5_y = NULL;
  SFc5_nov11InstanceStruct *chartInstance;
  chartInstance = (SFc5_nov11InstanceStruct *)chartInstanceVoid;
  ...
  mxArray *c5_q3, const char_T *c5_identifier)
{
  ...
  c5_y = c5_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_q3), &c5_thisId);
  sf_mex_destroy(&c5_q3);
  return c5_y;
}
  ...
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData)
{
  ...
  SFc5_nov11InstanceStruct *chartInstance;
  chartInstance = (SFc5_nov11InstanceStruct *)chartInstanceVoid;
  c5_q3 = sf_mex_dup(c5_mxArrayInData);
...
const mxArray *sf_c5_nov11_get_eml_resolved_functions_info(void)
{
  const mxArray *c5_nameCaptureInfo = NULL;
  c5_nameCaptureInfo = NULL;
  sf_mex_assign(&c5_nameCaptureInfo, sf_mex_createstruct("structure", 2, 35, 1),
                false);
...
static void c5_info_helper(const mxArray **c5_info)
{
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/cos.m"), "resolved",
                  "resolved", 0);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1343855572U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_cos.m"),
                  "resolved", "resolved", 1);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1286843922U), "fileTimeLo",
                  "fileTimeLo", 1);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 1);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sin.m"), "resolved",
                  "resolved", 2);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1343855586U), "fileTimeLo",
                  "fileTimeLo", 2);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 2);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_sin.m"),
                  "resolved", "resolved", 3);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1286843936U), "fileTimeLo",
                  "fileTimeLo", 3);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 3);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("mpower"), "name", "name", 4);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 4);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "resolved",
                  "resolved", 4);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1363735478U), "fileTimeLo",
                  "fileTimeLo", 4);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 4);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/isBuiltInNumeric.m"),
                  "resolved", "resolved", 5);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1363736156U), "fileTimeLo",
                  "fileTimeLo", 5);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 5);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 6);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("ismatrix"), "name", "name", 6);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 6);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 7);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("power"), "name", "name", 7);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 7);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m"), "resolved",
                  "resolved", 7);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1363735480U), "fileTimeLo",
                  "fileTimeLo", 7);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 7);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m!fltpower"), "context",
                  "context", 13);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("floor"), "name", "name", 13);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 13);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m"), "resolved",
                  "resolved", 13);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1363735454U), "fileTimeLo",
                  "fileTimeLo", 13);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 13);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1286843926U), "fileTimeLo",
                  "fileTimeLo", 15);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 15);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("mrdivide"), "name", "name", 17);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 17);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 17);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1370035086U), "mFileTimeLo",
                  "mFileTimeLo", 17);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 17);
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "context",
                  "context", 19);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("rdivide"), "name", "name", 19);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 19);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1286843996U), "fileTimeLo",
                  "fileTimeLo", 21);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 21);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "context",
                  "context", 22);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("eml_div"), "name", "name", 22);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 22);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, sf_mex_duplicatearraysafe(&c5_lhs23), "lhs", "lhs",
                  23);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(""), "context", "context", 24);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("acos"), "name", "name", 24);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 24);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/acos.m"), "resolved",
                  "resolved", 24);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1343855566U), "fileTimeLo",
                  "fileTimeLo", 24);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 24);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_error.m"), "resolved",
                  "resolved", 25);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1343855558U), "fileTimeLo",
                  "fileTimeLo", 25);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 25);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/acos.m"), "context",
                  "context", 26);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("eml_scalar_acos"), "name",
                  "name", 26);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 26);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1343855576U), "fileTimeLo",
                  "fileTimeLo", 26);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 26);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("sqrt"), "name", "name", 27);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 27);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1286843938U), "fileTimeLo",
                  "fileTimeLo", 29);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 29);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("asin"), "name", "name", 30);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 30);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/asin.m"), "resolved",
                  "resolved", 30);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1343855570U), "fileTimeLo",
                  "fileTimeLo", 30);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 30);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("atan"), "name", "name", 33);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 33);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1286843918U), "fileTimeLo",
                  "fileTimeLo", 34);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 34);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
...
static void c5_eml_error(SFc5_nov11InstanceStruct *chartInstance)
{
  ...
  const mxArray *c5_y = NULL;
  int32_T c5_i1;
  static char_T c5_cv1[4] = { 'a', 'c', 'o', 's' };
...
static void c5_b_eml_error(SFc5_nov11InstanceStruct *chartInstance)
{
  ...
  for (c5_i2 = 0; c5_i2 < 30; c5_i2++) {
    c5_u[c5_i2] = c5_cv2[c5_i2];
  }

  c5_y = NULL;
  sf_mex_assign(&c5_y, sf_mex_create("y", c5_u, 10, 0U, 1U, 0U, 2, 1, 30), false);
  for (c5_i3 = 0; c5_i3 < 4; c5_i3++) {
    c5_b_u[c5_i3] = c5_cv3[c5_i3];
  }
...
static void c5_c_eml_error(SFc5_nov11InstanceStruct *chartInstance)
{
  ...
  const mxArray *c5_y = NULL;
  int32_T c5_i5;
  static char_T c5_cv5[4] = { 'a', 's', 'i', 'n' };

  char_T c5_b_u[4];
  const mxArray *c5_b_y = NULL;
  (void)chartInstance;
  for (c5_i4 = 0; c5_i4 < 30; c5_i4++) {
    c5_u[c5_i4] = c5_cv4[c5_i4];
  }

  c5_y = NULL;
  sf_mex_assign(&c5_y, sf_mex_create("y", c5_u, 10, 0U, 1U, 0U, 2, 1, 30), false);
  for (c5_i5 = 0; c5_i5 < 4; c5_i5++) {
    c5_b_u[c5_i5] = c5_cv5[c5_i5];
  }
  ...
  const mxArray *c5_b_is_active_c5_nov11, const char_T *c5_identifier)
{
  ...
  c5_thisId.fIdentifier = c5_identifier;
  c5_thisId.fParent = NULL;
  c5_y = c5_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_b_is_active_c5_nov11),
    &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_nov11);
  return c5_y;
}
...
void sf_c5_nov11_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(532770021U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(736467277U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1252911614U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3578693195U);
}

mxArray *sf_c5_nov11_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("BFf70eBdF4dWj5KbLVcMDF");
...
mxArray *sf_c5_nov11_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c5_nov11_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c5_nov11(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[15],T\"q1\",},{M[1],M[16],T\"q2\",},{M[1],M[17],T\"q3\",},{M[8],M[0],T\"is_active_c5_nov11\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_nov11_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc5_nov11InstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        init_script_number_translation(_nov11MachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_nov11MachineNumber_,
          ...
          _SFD_SET_DATA_PROPS(3,2,0,1,"q1");
          _SFD_SET_DATA_PROPS(4,2,0,1,"q2");
          _SFD_SET_DATA_PROPS(5,2,0,1,"q3");
          _SFD_SET_DATA_PROPS(6,1,1,0,"tf");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,386);
        _SFD_CV_INIT_EML_IF(0,1,0,62,72,112,378);
        _SFD_CV_INIT_EML_IF(0,1,1,112,126,171,378);
...

        {
          ...
          real_T *c5_q3;
          real_T *c5_tf;
          c5_tf = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
          c5_q3 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 3);
          c5_q2 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
          c5_q1 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c5_wz = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
          ...
          _SFD_SET_DATA_VALUE_PTR(2U, c5_wz);
          _SFD_SET_DATA_VALUE_PTR(3U, c5_q1);
          _SFD_SET_DATA_VALUE_PTR(4U, c5_q2);
          _SFD_SET_DATA_VALUE_PTR(5U, c5_q3);
          _SFD_SET_DATA_VALUE_PTR(6U, c5_tf);
        }
      }
    } else {
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _nov11MachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  return "jSwIFlejQDGJIW2HKn0fFF";
}

static void sf_opaque_initialize_c5_nov11(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_nov11InstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c5_nov11((SFc5_nov11InstanceStruct*) chartInstanceVar);
  initialize_c5_nov11((SFc5_nov11InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_nov11(void *chartInstanceVar)
{
  enable_c5_nov11((SFc5_nov11InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_nov11(void *chartInstanceVar)
{
  disable_c5_nov11((SFc5_nov11InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_nov11(void *chartInstanceVar)
{
  sf_gateway_c5_nov11((SFc5_nov11InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c5_nov11(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_nov11((SFc5_nov11InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_nov11();/* state var info */
...
extern void sf_internal_set_sim_state_c5_nov11(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c5_nov11();/* state var info */
  ...
  set_sim_state_c5_nov11((SFc5_nov11InstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c5_nov11(SimStruct* S)
{
  return sf_internal_get_sim_state_c5_nov11(S);
}

static void sf_opaque_set_sim_state_c5_nov11(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c5_nov11(S, st);
}

static void sf_opaque_terminate_c5_nov11(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_nov11InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_nov11_optimization_info();
    }

    finalize_c5_nov11((SFc5_nov11InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_nov11((SFc5_nov11InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_nov11(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c5_nov11((SFc5_nov11InstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c5_nov11(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_nov11_optimization_info();
  ...
  ssSetChecksum0(S,(3117041350U));
  ssSetChecksum1(S,(1017114061U));
  ssSetChecksum2(S,(4140281649U));
  ssSetChecksum3(S,(3234829978U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c5_nov11(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_nov11(SimStruct *S)
{
  SFc5_nov11InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc5_nov11InstanceStruct *)utMalloc(sizeof
    (SFc5_nov11InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_nov11InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c5_nov11;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c5_nov11;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c5_nov11;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c5_nov11;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c5_nov11;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c5_nov11;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c5_nov11;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c5_nov11;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_nov11;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_nov11;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c5_nov11;
...
void c5_nov11_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_nov11(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_nov11(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_nov11_method_dispatcher.\n"
